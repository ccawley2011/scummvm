...
const char *const S2_MEI_NORMAL_NAMES[] = {
...
const char *const S2_MEI_SHADOW_NAMES[] = {
	"mctsh1",
	"mctsh2",
	"mctsh3",
	"mctsh4",
...
const char *const S2_PEASANT_NORMAL_NAMES[] = { "pesky walk pos3" };
const int16 S2_PEASANT_SHADOW_DIRS[] = { 250, -1 };
const char *const S2_PEASANT_SHADOW_NAMES[] = { "shadow pesky walk pos3" };

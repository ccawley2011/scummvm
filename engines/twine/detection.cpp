...
#define TWINE_DETECTION_ENTRY(gameid, extra, filesDescriptions, platform, adgf, flags) \
	{ \
		{ \
			gameid,            \
			extra,             \
...
static const TwinE::TwinEGameDescription twineGameDescriptions[] = {
	...
	TWINE_DETECTION_ENTRY("lba", "Demo Version", AD_ENTRY1s("RELENT.EXE", "c1a887e38283d43f271249ad9f2a73ef", 245961), Common::kPlatformDOS, ADGF_DEMO, 0),

	// Little Big Adventure - Original European Version (EN, FR, DE, IT, ES)
	// LBA.EXE
	// 14 Oct 1994 at 12:45
	TWINE_DETECTION_ENTRY("lba", "CD Original European Version", AD_ENTRY1s("LBA.EXE", "c1a887e38283d43f271249ad9f2a73ef", 258513), Common::kPlatformDOS, ADGF_CD, 0),

	// Relentless: Twinsen's Adventure - Original North America Version (EN, FR, DE, IT, ES)
	// RELENT.EXE
	// 14 Oct 1994 at 13:22
	TWINE_DETECTION_ENTRY("lba", "Relentless: Twinsen's Adventure - CD Original North America Version", AD_ENTRY1s("RELENT.EXE", "c1a887e38283d43f271249ad9f2a73ef", 258513), Common::kPlatformDOS, ADGF_CD, TwinE::TF_VERSION_USA),
	...
	TWINE_DETECTION_ENTRY("lba", "DotEmu Version (Steam)", AD_ENTRY1s("LBA.DOT", "6dc00342c80bc41b4ff5a43c560c7abc", 380666496), Common::kPlatformDOS, ADGF_NO_FLAGS, 0),

	// Little Big Adventure (CD Spanish)
	TWINE_DETECTION_ENTRY("lba", "", AD_ENTRY1s("text.hqr", "ae7343552f8fbd17a1fc6cea2197a912", 248654), Common::kPlatformDOS, ADGF_NO_FLAGS, 0),

	// Little Big Adventure - DotEmu Enhanced Version (Steam)
	// LBA.exe
	// 27 February 2018 at 08:10
	TWINE_DETECTION_ENTRY("lba", "DotEmu Enhanced Version (Steam)", AD_ENTRY1s("LBA.exe", "1f176b4329fbc7efc8f9f30f97013c5f", 1165728), Common::kPlatformWindows, ADGF_NO_FLAGS, TwinE::TF_DOTEMU_ENHANCED),

	// Little Big Adventure - DotEmu Enhanced Version (Android)
	// liblba.so
	// 8 Sep 2014 at 15:56
	TWINE_DETECTION_ENTRY("lba", "DotEmu", AD_ENTRY1s("text.hqr", "a374c93450dd2bb874b7167a63974e8d", 377224), Common::kPlatformAndroid, ADGF_NO_FLAGS, TwinE::TF_DOTEMU_ENHANCED),

	// Twinsen's Little Big Adventure Classic - 2015 Edition (Steam)
	TWINE_DETECTION_ENTRY("lba", "DotEmu (Steam)", AD_ENTRY1s("LBA.EXE", "615a9a0c3dae2c3b5fca0dee4d84dc72", 931328), Common::kPlatformWindows, ADGF_NO_FLAGS, TwinE::TF_DOTEMU_ENHANCED),

	// Little Big Adventure - GOG Version
	// LBA.GOG
	// 11 October 2011 at 17:30
	TWINE_DETECTION_ENTRY("lba", "GOG.com Version", AD_ENTRY1s("LBA.GOG", "6dc00342c80bc41b4ff5a43c560c7abc", 380666496), Common::kPlatformDOS, ADGF_NO_FLAGS, 0),
	...
	// TLBA1C.exe
	// 31 May 2022 12:58
	TWINE_DETECTION_ENTRY("lba", "Classic Version (Steam)", AD_ENTRY1s("TLBA1C.exe", "38b038eee2d93a5bc0e0405886161252", 4417024), Common::kPlatformWindows, ADGF_NO_FLAGS, TwinE::TF_LBA1_CLASSIC),

	// Little Big Adventure - Steam Version
	// TLBA1C.exe
	// 10 Jun 2022 14:51
	TWINE_DETECTION_ENTRY("lba", "Classic Version (Steam)", AD_ENTRY1s("TLBA1C.exe", "e4bab4647eabb998f627ac7628d94790", 4418048), Common::kPlatformWindows, ADGF_NO_FLAGS, TwinE::TF_LBA1_CLASSIC),

	// Little Big Adventure - Steam Version (3.2.2)
	// TLBA1C.exe
	// 1 Jul 2022
	TWINE_DETECTION_ENTRY("lba", "Classic Version (Steam)", AD_ENTRY1s("TLBA1C.exe", "58a7fba8a556196bb14d4f492017fb2b", 4416000), Common::kPlatformWindows, ADGF_NO_FLAGS, TwinE::TF_LBA1_CLASSIC),

	// Little Big Adventure - Steam Version (3.2.3)
	// TLBA1C.exe
	// 8 Sep 2022
	TWINE_DETECTION_ENTRY("lba", "Classic Version (Steam)", AD_ENTRY1s("TLBA1C.exe", "01f38555eca4a5dd076a4599359de4eb", 4445696), Common::kPlatformWindows, ADGF_NO_FLAGS, TwinE::TF_LBA1_CLASSIC),

	// Little Big Adventure - GOG Version 3.2.0 (56122)
	// TLBA1C.exe
	// 1st June 2022 02:18
	TWINE_DETECTION_ENTRY("lba", "GOG.com Classic Version", AD_ENTRY1s("TLBA1C.exe", "e377d036e997acbf543bc3023ce72be6", 4404224), Common::kPlatformWindows, ADGF_NO_FLAGS, TwinE::TF_LBA1_CLASSIC),

	// Little Big Adventure - GOG Version 3.2.1 (56604)
	// TLBA1C.exe
	// 17 Jun 2022 00:30
	TWINE_DETECTION_ENTRY("lba", "GOG.com Classic Version", AD_ENTRY1s("TLBA1C.exe", "e86192e4a491805dc011dda5ca83c608", 4404736), Common::kPlatformWindows, ADGF_NO_FLAGS, TwinE::TF_LBA1_CLASSIC),

	// Little Big Adventure - GOG Version 3.2.2
	// TLBA1C.exe
	// 1 Jul 2022
	TWINE_DETECTION_ENTRY("lba", "GOG.com Classic Version", AD_ENTRY1s("TLBA1C.exe", "76b227e87038c17a3376b1c681f15474", 4402688), Common::kPlatformWindows, ADGF_NO_FLAGS, TwinE::TF_LBA1_CLASSIC),

	// Little Big Adventure - GOG Version 3.2.3.1 (58613)
	// TLBA1C.exe
	TWINE_DETECTION_ENTRY("lba", "GOG.com Classic Version", AD_ENTRY1s("TLBA1C.exe", "252216e83f83dc770fafc7fd787a6da5", 4432896), Common::kPlatformWindows, ADGF_NO_FLAGS, TwinE::TF_LBA1_CLASSIC),
	...
	// LBA2.EXE
	// 4 Sep 2004 at 18:44
	TWINE_DETECTION_ENTRY("lba2", "CD Original European Version", AD_ENTRY1s("LBA2.EXE", "ba915d65b3c7a743a87804f73f29675b", 616448), Common::kPlatformDOS, ADGF_UNSTABLE, 0),
	TWINE_DETECTION_ENTRY("lba2", "CD Original European Version", AD_ENTRY1s("text.hqr", "dafcec7d9f1b2ab4a12d478786eb0f61", 443010), Common::kPlatformDOS, ADGF_UNSTABLE, 0),

	{ AD_TABLE_END_MARKER, 0 }
};

class TwinEMetaEngineDetection : public AdvancedMetaEngineDetection<TwinE::TwinEGameDescription> {
public:

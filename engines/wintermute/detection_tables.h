...
// Convenience variants, as most of the games are Windows-games
...
#define WME_WINENTRY_3D(shortName, extraName, hashEntry, lang, status, version) \
	{ \
		{ \
			shortName, \
			extraName, \
...
#define WME_WINENTRY_FLAGS(shortName, extraName, hashEntry, lang, status, version, flags) \
	{ \
		{ \
			shortName, \
			extraName, \
...
#define WME_WINENTRY_3D_FLAGS(shortName, extraName, hashEntry, lang, status, version, flags) \
	{ \
		{ \
			shortName, \
			extraName, \
...
static const WMEGameDescription gameDescriptions[] = {
	...
	WME_WINENTRY_3D("alavi", "Beta version",
		WME_ENTRY1s("data.dcp", "587b46baa3f82dfe09bdb51f01231fa2", 37191939), Common::FA_IRN, ADGF_UNSTABLE | ADGF_DEMO, WME_ANDISHE_VARAN),

	// Alavi Detective - Murder of Miss Rojan (Persian) (Try version, between 1388/8)
	WME_WINENTRY_3D("alavi", "Try version",
	...
	WME_WINENTRY_3D("alavi", "",
		WME_ENTRY1s("data.dcp", "bffb07282d27b6c5351ed4fce92db4da", 516186290), Common::FA_IRN, ADGF_UNSTABLE, WME_ANDISHE_VARAN),
	...
	WME_WINENTRY_3D("alphapolaris", "",
		WME_ENTRY1s("data.dcp", "1df8eb749676752c3e0ab6e24d31971c", 748056178), Common::EN_ANY, ADGF_UNSTABLE, WME_1_9_1),
	...
	WME_WINENTRY_3D("alphapolaris", "1.1.0 (1280x800 Steam)",
	...
	WME_WINENTRY_3D("alphapolaris", "1.1.0 (1280x768 Steam)",
	...
	WME_WINENTRY_3D("alphapolaris", "Demo",
	...
	WME_WINENTRY_3D("alphapolaris", "Demo",
		WME_ENTRY1s("data.dcp", "c040af58c38c40997fce4b4832f43a5d", 416066977), Common::PL_POL, ADGF_UNSTABLE | ADGF_DEMO, WME_1_9_1),
	...
	WME_WINENTRY_3D("artofmurder1", "Demo",
	...
	WME_WINENTRY_3D("barrowhilldp", "",
		WME_ENTRY1s("data.dcp", "2b11a98ebc1afd07b4d03f650c32b12b", 1066752), Common::EN_ANY, ADGF_UNSTABLE, WME_1_9_3),

	// Basis Octavus
	WME_WINENTRY_3D("basisoctavus", "",
		WME_ENTRY1s("data.dcp", "021ef97f8f49ec33f83beae0d6e38f08", 49336909), Common::CS_CZE, ADGF_UNSTABLE, WME_1_9_1),
	...
	WME_WINENTRY_3D("darksummer", "",
		WME_ENTRY1s("data.dcp", "da1142983240a5bb62c32f79a863eac5", 1030873185), Common::FA_IRN, ADGF_UNSTABLE, WME_1_9_3),
	...
	WME_WINENTRY_3D("devilincapital", "",
		WME_ENTRY1s("data.dcp", "c54f7bc0b0d3d79096f9b999c23c9865", 1317026760), Common::FA_IRN, ADGF_UNSTABLE, WME_1_9_3),
	...
	// DFAF Adventure
	WME_WINENTRY_FLAGS("dfafadventure", "",
		WME_ENTRY1s("data.dcp", "5704ebef961176f647742aa66bd09352", 10083417), Common::EN_ANY, ADGF_UNSTABLE, WME_1_9_1, GF_LOWSPEC_ASSETS),
	...
	// Dreamcat
	WME_WINENTRY_FLAGS("dreamcat", "",
		WME_ENTRY1s("data.dcp", "189bd4eef29034f4ff4ed30120eaac4e", 7758040), Common::EN_ANY, ADGF_UNSTABLE, WME_1_9_1, GF_LOWSPEC_ASSETS),
	...
	WME_WINENTRY_3D("forgottensound1", "",
		WME_ENTRY1s("data.dcp", "1c5871ad711430663b1848f0f2362b44", 2030321701), Common::FA_IRN, ADGF_UNSTABLE, WME_1_9_1),
	...
	WME_WINENTRY_3D("forgottensound2", "",
		WME_ENTRY1s("data.dcp", "9e1b4f3dd41e8dee79698ea17bc9ab7b", 1630760876), Common::FA_IRN, ADGF_UNSTABLE, WME_1_9_3),
	...
	// Lov Mamuta
	WME_WINENTRY_3D("lovmamuta", "",
		WME_ENTRY1s("data.dcp", "ce2be4691fa0104cfdd63656cedaf810", 11198933), Common::CS_CZE, ADGF_UNSTABLE, WME_1_9_1),

	// J.U.L.I.A. (English)
	WME_WINENTRY_3D("julia", "",
	...
	WME_WINENTRY_3D("julia", "Version 1.2",
	...
	WME_WINENTRY_3D("julia", "Greenlight Demo",
	...
	WME_WINENTRY_FLAGS("juliastars", "HD Ready Version/Steam",
		WME_ENTRY2s("data_sd.dcp", "9949302dfaea943113e2f0ee0dd468be", 4249680,
					"data_sd.dcp", "9949302dfaea943113e2f0ee0dd468be", 4249680), Common::EN_ANY, ADGF_UNSTABLE, WME_LITE, GF_IGNORE_HD_FILES),

	// J.U.L.I.A.: Among the Stars (Full HD Version) (Steam, January 2017) (English)
	WME_WINENTRY_FLAGS("juliastars", "Full HD Version/Steam",
		WME_ENTRY2s("data_hd.dcp", "fd579fa333f117882190993ea4f3bba5", 5164463,
					"data_hd.dcp", "fd579fa333f117882190993ea4f3bba5", 5164463), Common::EN_ANY, ADGF_UNSTABLE, WME_LITE, GF_IGNORE_SD_FILES),
	...
	WME_WINENTRY_FLAGS("juliastars", "HD Ready Version/Steam",
		WME_ENTRY2s("data_sd.dcp", "dfaf7e730a66412f68d11cddb0c8737d", 4505667,
					"german_sd.dcp", "23ceb8625cebfe32aaa5950e89ac68ba", 123326075), Common::DE_DEU, ADGF_UNSTABLE, WME_LITE, GF_IGNORE_HD_FILES),
	...
	WME_WINENTRY_FLAGS("juliastars", "Full HD Version/Steam",
		WME_ENTRY2s("data_hd.dcp", "f40b3d0778e37c61cf309d214446d233", 5264780,
					"german_hd.dcp", "8d85f83a3fc8f1bec4e5ba2158b05b1e", 152499998), Common::DE_DEU, ADGF_UNSTABLE, WME_LITE, GF_IGNORE_SD_FILES),
	...
	WME_WINENTRY_FLAGS("juliastars", "HD Ready Version/Steam",
		WME_ENTRY2s("data_sd.dcp", "da3508bd60025bac35211fb6fc959d88", 5655554,
					"data_sd.dcp", "da3508bd60025bac35211fb6fc959d88", 5655554), Common::ES_ESP, ADGF_UNSTABLE, WME_LITE, GF_IGNORE_HD_FILES),
	...
	WME_WINENTRY_FLAGS("juliastars", "Full HD Version/Steam",
		WME_ENTRY2s("data_hd.dcp", "da3508bd60025bac35211fb6fc959d88", 5655554,
					"data_hd.dcp", "da3508bd60025bac35211fb6fc959d88", 5655554), Common::ES_ESP, ADGF_UNSTABLE, WME_LITE, GF_IGNORE_SD_FILES),

	// J.U.L.I.A.: Among the Stars (HD Ready Version) (GOG) (English)
	WME_WINENTRY_FLAGS("juliastars", "HD Ready Version/GOG.com",
		WME_ENTRY2s("data_sd.dcp", "da1f147a5f2ee6eb0750678a8b955c93", 4526792,
					"data_sd.dcp", "da1f147a5f2ee6eb0750678a8b955c93", 4526792), Common::EN_ANY, ADGF_UNSTABLE, WME_LITE, GF_IGNORE_HD_FILES),

	// J.U.L.I.A.: Among the Stars (Full HD Version) (GOG) (English)
	WME_WINENTRY_FLAGS("juliastars", "Full HD Version/GOG.com",
		WME_ENTRY2s("data_hd.dcp", "91dcb65523da943f22fca0c025a2ce8e", 5281911,
					"data_hd.dcp", "91dcb65523da943f22fca0c025a2ce8e", 5281911), Common::EN_ANY, ADGF_UNSTABLE, WME_LITE, GF_IGNORE_SD_FILES),

	// J.U.L.I.A.: Among the Stars (HD Ready Version) (GOG) (German)
	WME_WINENTRY_FLAGS("juliastars", "HD Ready Version/GOG.com",
		WME_ENTRY2s("data_sd.dcp", "070d13b70e35cd95855ddc1687446631", 4526795,
					"german_sd.dcp", "85eb39225083465225c30261a6bcd63e", 123326134), Common::DE_DEU, ADGF_UNSTABLE, WME_LITE, GF_IGNORE_HD_FILES),

	// J.U.L.I.A.: Among the Stars (Full HD Version) (GOG) (German)
	WME_WINENTRY_FLAGS("juliastars", "Full HD Version/GOG.com",
		WME_ENTRY2s("data_hd.dcp", "7973ca635255d3791123fd750cb848f2", 5281925,
					"german_hd.dcp", "19a771b1a933b71b889026d53734b0c0", 152500044), Common::DE_DEU, ADGF_UNSTABLE, WME_LITE, GF_IGNORE_SD_FILES),
	...
	WME_WINENTRY_FLAGS("juliastars", "HD Ready Version/GOG.com",
		WME_ENTRY2s("data_sd.dcp", "29f4856cc1514bdb86d3b19a39d86d76", 5877935,
					"data_sd.dcp", "29f4856cc1514bdb86d3b19a39d86d76", 5877935), Common::ES_ESP, ADGF_UNSTABLE, WME_LITE, GF_IGNORE_HD_FILES),
	...
	WME_WINENTRY_FLAGS("juliastars", "Full HD Version/GOG.com",
		WME_ENTRY2s("data_hd.dcp", "29f4856cc1514bdb86d3b19a39d86d76", 5877935,
					"data_hd.dcp", "29f4856cc1514bdb86d3b19a39d86d76", 5877935), Common::ES_ESP, ADGF_UNSTABLE, WME_LITE, GF_IGNORE_SD_FILES),
	...
	WME_WINENTRY_3D("mentalrepairs", "",
		WME_ENTRY2s("data.dcp", "414d423bbff697f22fb38932f030e897", 59518068,
					"string.tab", "d3393ba2445fc7e6a1cdf8fe95c59659", 72143), Common::PL_POL, ADGF_UNSTABLE, WME_1_8_6),
	...
	WME_WINENTRY_3D("miskatonic1", "",
		WME_ENTRY1s("Miskatonic.exe", "4c52d1cdc6dc708f47049b5c88a5b866", 339002997), Common::EN_ANY, ADGF_UNSTABLE, WME_1_9_1),
	...
	WME_WINENTRY_3D("mukhtar", "",
		WME_ENTRY1s("data.dcp", "ed1deb8e6b2ce0a50ba26e035bdb7006", 1086177292), Common::RU_RUS, ADGF_UNSTABLE, WME_1_9_1),
	...
	// Open Quest
	WME_WINENTRY_FLAGS("openquest", "",
		WME_ENTRY1s("data.dcp", "16893e3fc15a211a49654ae66f684f28", 82281736), Common::EN_ANY, ADGF_UNSTABLE, WME_1_9_1, GF_LOWSPEC_ASSETS),
	...
	// Palladion (Alpha6h)
	WME_WINENTRY_3D("palladion", "Alpha6h",
	...
	// Pizza Morgana (Demo)
	WME_WINENTRY_3D("pizzamorgana", "Demo",
	...
	WME_WINENTRY_3D("reptilesquest", "Beta 2.5",
	...
	WME_WINENTRY_3D("sof1", "",
		WME_ENTRY2s("data.dcp", "6f96e541de77de1999feabb2ec6ac877", 952625188,
					"local.dcp", "d130c371faaf3f6767a7dd230650130d", 201155672), Common::EN_ANY, ADGF_UNSTABLE, WME_1_8_10),

	// Stroke of Fate: Operation Valkyrie (Russian)
	WME_WINENTRY_3D("sof1", "",
		WME_ENTRY2s("data.dcp", "ae4ba7a60da6c706b2f914f8b173295e", 930410566,
					"local.dcp", "3f846bb0673dc92512dea526ce01a4fb", 431994000), Common::RU_RUS, ADGF_UNSTABLE, WME_1_8_10),

	// Stroke of Fate: Operation Valkyrie (Spanish)
	WME_WINENTRY_3D("sof1", "",
		WME_ENTRY2s("data.dcp", "e5032a792e63bb8210f3eab96402614d", 951892593,
					"local.dcp", "2d8af7da80c91ef8bfa594b5f50693ab", 201101595), Common::ES_ESP, ADGF_UNSTABLE, WME_1_8_10),

	// Stroke of Fate: Operation Bunker (English)
	WME_WINENTRY_3D("sof2", "",
		WME_ENTRY2s("data.dcp", "9f4de2a53ef396cc70786a1dc0ab191d", 828351641,
					"local.dcp", "a78f5353c6539b4ff9c39223202ba8d0", 433003083), Common::EN_ANY, ADGF_UNSTABLE, WME_1_8_9),
	...
	WME_WINENTRY_3D_FLAGS("sotv1", "Legacy Version/Steam",
		WME_ENTRY3s("data.dcp", "e19b63c6aa19d491a4f533ac9c1609ef", 97061505,
					"data_sd.dcp", "aee08a5a713c1b45e67471134772f72f", 97833631,
					"i18n_de_strings.dcp", "9cc009980d018476b177e2a4075f56b4", 43104), Common::DE_DEU, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_HD_FILES),

	// Shadows on the Vatican - Act I: Greed (Legacy Version) (Steam, Jul 2014) (English)
	WME_WINENTRY_3D_FLAGS("sotv1", "Legacy Version/Steam",
		WME_ENTRY3s("data.dcp", "e19b63c6aa19d491a4f533ac9c1609ef", 97061505,
					"data_sd.dcp", "aee08a5a713c1b45e67471134772f72f", 97833631,
					"i18n_en_strings.dcp", "40f8ea49a3e8d54a5202aa88c12fba80", 75108), Common::EN_ANY, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_HD_FILES),

	// Shadows on the Vatican - Act I: Greed (Legacy Version) (Steam, Jul 2014) (Spanish)
	WME_WINENTRY_3D_FLAGS("sotv1", "Legacy Version/Steam",
		WME_ENTRY3s("data.dcp", "e19b63c6aa19d491a4f533ac9c1609ef", 97061505,
					"data_sd.dcp", "aee08a5a713c1b45e67471134772f72f", 97833631,
					"i18n_es_strings.dcp", "6a8d5b434dfe758abb2ace1a75a4dab1", 40122), Common::ES_ESP, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_HD_FILES),

	// Shadows on the Vatican - Act I: Greed (Legacy Version) (Steam, Jul 2014) (French)
	WME_WINENTRY_3D_FLAGS("sotv1", "Legacy Version/Steam",
		WME_ENTRY3s("data.dcp", "e19b63c6aa19d491a4f533ac9c1609ef", 97061505,
					"data_sd.dcp", "aee08a5a713c1b45e67471134772f72f", 97833631,
					"i18n_fr_strings.dcp", "b3fe8c720bb6a5378f6da2f593339c70", 40760), Common::FR_FRA, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_HD_FILES),

	// Shadows on the Vatican - Act I: Greed (Legacy Version) (Steam, Jul 2014) (Italian)
	WME_WINENTRY_3D_FLAGS("sotv1", "Legacy Version/Steam",
		WME_ENTRY3s("data.dcp", "e19b63c6aa19d491a4f533ac9c1609ef", 97061505,
					"data_sd.dcp", "aee08a5a713c1b45e67471134772f72f", 97833631,
					"i18n_it_strings.dcp", "5abaab4d57d7585b3c4b23f34f2d0dd8", 40468), Common::IT_ITA, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_HD_FILES),
	...
	WME_WINENTRY_3D_FLAGS("sotv1", "Legacy Version/Steam",
		WME_ENTRY3s("data.dcp", "e382f34f0bd319ad310aba2ecd239dec", 95879376,
					...
					"i18n_de_strings.dcp", "780b0d8d4f2b2b32e729090c1018df43", 43136), Common::DE_DEU, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_HD_FILES),

	// Shadows on the Vatican - Act I: Greed (Legacy Version) (Steam, Feb 12th 2015) (English)
	WME_WINENTRY_3D_FLAGS("sotv1", "Legacy Version/Steam",
		WME_ENTRY3s("data.dcp", "e382f34f0bd319ad310aba2ecd239dec", 95879376,
					"data_sd.dcp", "6842ddf537f2cd186df050aa8c05d363", 97835480,
					"i18n_en_strings.dcp", "636e32cf89f02fca30a6f4caa38dede1", 75126), Common::EN_ANY, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_HD_FILES),

	// Shadows on the Vatican - Act I: Greed (Legacy Version) (Steam, Feb 12th 2015) (Spanish)
	WME_WINENTRY_3D_FLAGS("sotv1", "Legacy Version/Steam",
		WME_ENTRY3s("data.dcp", "e382f34f0bd319ad310aba2ecd239dec", 95879376,
					"data_sd.dcp", "6842ddf537f2cd186df050aa8c05d363", 97835480,
					"i18n_es_strings.dcp", "c62f94e9cd543ecbdc0f02acc744cd29", 40153), Common::ES_ESP, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_HD_FILES),

	// Shadows on the Vatican - Act I: Greed (Legacy Version) (Steam, Feb 12th 2015) (French)
	WME_WINENTRY_3D_FLAGS("sotv1", "Legacy Version/Steam",
		WME_ENTRY3s("data.dcp", "e382f34f0bd319ad310aba2ecd239dec", 95879376,
					"data_sd.dcp", "6842ddf537f2cd186df050aa8c05d363", 97835480,
					"i18n_fr_strings.dcp", "548e88d67be123bb54f5b265226f051a", 40807), Common::FR_FRA, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_HD_FILES),

	// Shadows on the Vatican - Act I: Greed (Legacy Version) (Steam, Feb 12th 2015) (Italian)
	WME_WINENTRY_3D_FLAGS("sotv1", "Legacy Version/Steam",
		WME_ENTRY3s("data.dcp", "e382f34f0bd319ad310aba2ecd239dec", 95879376,
					"data_sd.dcp", "6842ddf537f2cd186df050aa8c05d363", 97835480,
					"i18n_it_strings.dcp", "c3d180dd634705cb16ccd650066e1da8", 40502), Common::IT_ITA, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_HD_FILES),

	// Shadows on the Vatican - Act I: Greed (Legacy Version) (Steam, Feb 12th 2015) (Polish)
	WME_WINENTRY_3D_FLAGS("sotv1", "Legacy Version/Steam",
		WME_ENTRY3s("data.dcp", "e382f34f0bd319ad310aba2ecd239dec", 95879376,
					"data_sd.dcp", "6842ddf537f2cd186df050aa8c05d363", 97835480,
					"i18n_pl_strings.dcp", "8dac09efb73ae4a7a2b897de6f37e906", 40062), Common::PL_POL, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_HD_FILES),

	// Shadows on the Vatican - Act I: Greed (Legacy Version) (Steam, Feb 12th 2015) (Russian)
	WME_WINENTRY_3D_FLAGS("sotv1", "Legacy Version/Steam",
		WME_ENTRY3s("data.dcp", "e382f34f0bd319ad310aba2ecd239dec", 95879376,
					"data_sd.dcp", "6842ddf537f2cd186df050aa8c05d363", 97835480,
					"i18n_ru_strings.dcp", "88daa5c022c18535e2da86fa558db792", 45838), Common::RU_RUS, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_HD_FILES),
	...
	WME_WINENTRY_3D_FLAGS("sotv1", "Legacy Version/Steam",
		WME_ENTRY3s("data.dcp", "bb6136d76ebadf06c90877283aa1d55a", 95890682,
					...
					"i18n_de_strings.dcp", "d245d247a282cda33b83ed6918b2e6d5", 43136), Common::DE_DEU, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_HD_FILES),

	// Shadows on the Vatican - Act I: Greed (Legacy Version) (Steam, Feb 22th 2015) (English)
	WME_WINENTRY_3D_FLAGS("sotv1", "Legacy Version/Steam",
		WME_ENTRY3s("data.dcp", "bb6136d76ebadf06c90877283aa1d55a", 95890682,
					"data_sd.dcp", "6135b62bb28434c1af42de84ef8b96fe", 97808411,
					"i18n_en_strings.dcp", "5e9cf5a8403b98f7d92de55efccc0d34", 75119), Common::EN_ANY, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_HD_FILES),

	// Shadows on the Vatican - Act I: Greed (Legacy Version) (Steam, Feb 22th 2015) (Spanish)
	WME_WINENTRY_3D_FLAGS("sotv1", "Legacy Version/Steam",
		WME_ENTRY3s("data.dcp", "bb6136d76ebadf06c90877283aa1d55a", 95890682,
					"data_sd.dcp", "6135b62bb28434c1af42de84ef8b96fe", 97808411,
					"i18n_es_strings.dcp", "edb19a0758243da8929844bac035d384", 40153), Common::ES_ESP, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_HD_FILES),

	// Shadows on the Vatican - Act I: Greed (Legacy Version) (Steam, Feb 22th 2015) (French)
	WME_WINENTRY_3D_FLAGS("sotv1", "Legacy Version/Steam",
		WME_ENTRY3s("data.dcp", "bb6136d76ebadf06c90877283aa1d55a", 95890682,
					"data_sd.dcp", "6135b62bb28434c1af42de84ef8b96fe", 97808411,
					"i18n_fr_strings.dcp", "40dda8156fa93717cf962e75d76929b1", 40807), Common::FR_FRA, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_HD_FILES),

	// Shadows on the Vatican - Act I: Greed (Legacy Version) (Steam, Feb 22th 2015) (Italian)
	WME_WINENTRY_3D_FLAGS("sotv1", "Legacy Version/Steam",
		WME_ENTRY3s("data.dcp", "bb6136d76ebadf06c90877283aa1d55a", 95890682,
					"data_sd.dcp", "6135b62bb28434c1af42de84ef8b96fe", 97808411,
					"i18n_it_strings.dcp", "0d1dac14379e55356794fb7cca8865b2", 40502), Common::IT_ITA, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_HD_FILES),

	// Shadows on the Vatican - Act I: Greed (Legacy Version) (Steam, Feb 22th 2015) (Polish)
	WME_WINENTRY_3D_FLAGS("sotv1", "Legacy Version/Steam",
		WME_ENTRY3s("data.dcp", "bb6136d76ebadf06c90877283aa1d55a", 95890682,
					"data_sd.dcp", "6135b62bb28434c1af42de84ef8b96fe", 97808411,
					"i18n_pl_strings.dcp", "cdd0b203c591dfb411cb6fc89ac009c1", 40062), Common::PL_POL, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_HD_FILES),

	// Shadows on the Vatican - Act I: Greed (Legacy Version) (Steam, Feb 22th 2015) (Russian)
	WME_WINENTRY_3D_FLAGS("sotv1", "Legacy Version/Steam",
		WME_ENTRY3s("data.dcp", "bb6136d76ebadf06c90877283aa1d55a", 95890682,
					"data_sd.dcp", "6135b62bb28434c1af42de84ef8b96fe", 97808411,
					"i18n_ru_strings.dcp", "77fc889bb25438bafe897d1566bd7e50", 45546), Common::RU_RUS, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_HD_FILES),
	...
	WME_WINENTRY_3D_FLAGS("sotv1", "Legacy Version/Steam",
		WME_ENTRY3s("data.dcp", "46bb5822abf6d422d08a68070e05bd86", 95890675,
					...
					"i18n_de_strings.dcp", "94230807d77dacb420f446c34dd60072", 43136), Common::DE_DEU, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_HD_FILES),

	// Shadows on the Vatican - Act I: Greed (Legacy Version) (Steam, Sep 2016) (English)
	WME_WINENTRY_3D_FLAGS("sotv1", "Legacy Version/Steam",
		WME_ENTRY3s("data.dcp", "46bb5822abf6d422d08a68070e05bd86", 95890675,
					"data_sd.dcp", "8864e2e552bb7816916d8c6630e8f1a5", 97821007,
					"i18n_en_strings.dcp", "253e7f5e2bb4a33c7df52a04624d18c6", 75119), Common::EN_ANY, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_HD_FILES),

	// Shadows on the Vatican - Act I: Greed (Legacy Version) (Steam, Sep 2016) (Spanish)
	WME_WINENTRY_3D_FLAGS("sotv1", "Legacy Version/Steam",
		WME_ENTRY3s("data.dcp", "46bb5822abf6d422d08a68070e05bd86", 95890675,
					"data_sd.dcp", "8864e2e552bb7816916d8c6630e8f1a5", 97821007,
					"i18n_es_strings.dcp", "2227cee67309f564178e48d3eb30fc98", 40153), Common::ES_ESP, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_HD_FILES),

	// Shadows on the Vatican - Act I: Greed (Legacy Version) (Steam, Sep 2016) (French)
	WME_WINENTRY_3D_FLAGS("sotv1", "Legacy Version/Steam",
		WME_ENTRY3s("data.dcp", "46bb5822abf6d422d08a68070e05bd86", 95890675,
					"data_sd.dcp", "8864e2e552bb7816916d8c6630e8f1a5", 97821007,
					"i18n_fr_strings.dcp", "f50d251df43e5433b9664d5c2463fb08", 40807), Common::FR_FRA, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_HD_FILES),

	// Shadows on the Vatican - Act I: Greed (Legacy Version) (Steam, Sep 2016) (Italian)
	WME_WINENTRY_3D_FLAGS("sotv1", "Legacy Version/Steam",
		WME_ENTRY3s("data.dcp", "46bb5822abf6d422d08a68070e05bd86", 95890675,
					"data_sd.dcp", "8864e2e552bb7816916d8c6630e8f1a5", 97821007,
					"i18n_it_strings.dcp", "6ad0d7c0a0c450d6af334cd1b4dbe72e", 40502), Common::IT_ITA, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_HD_FILES),

	// Shadows on the Vatican - Act I: Greed (Legacy Version) (Steam, Sep 2016) (Polish)
	WME_WINENTRY_3D_FLAGS("sotv1", "Legacy Version/Steam",
		WME_ENTRY3s("data.dcp", "46bb5822abf6d422d08a68070e05bd86", 95890675,
					"data_sd.dcp", "8864e2e552bb7816916d8c6630e8f1a5", 97821007,
					"i18n_pl_strings.dcp", "7c07fb021517dd21ba2e2a5739d0168e", 40062), Common::PL_POL, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_HD_FILES),

	// Shadows on the Vatican - Act I: Greed (Legacy Version) (Steam, Sep 2016) (Russian)
	WME_WINENTRY_3D_FLAGS("sotv1", "Legacy Version/Steam",
		WME_ENTRY3s("data.dcp", "46bb5822abf6d422d08a68070e05bd86", 95890675,
					"data_sd.dcp", "8864e2e552bb7816916d8c6630e8f1a5", 97821007,
					"i18n_ru_strings.dcp", "5cecc876ec1b364f22780d18a0821349", 45546), Common::RU_RUS, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_HD_FILES),
	...
	WME_WINENTRY_3D_FLAGS("sotv1", "Legacy Version/Steam",
		WME_ENTRY3s("data.dcp", "e0d5b1276cf80c858b7404f1f3381e2b", 95890675,
					...
					"i18n_de_strings.dcp", "59d15bb3c32354b5104475df0ff6c50b", 43136), Common::DE_DEU, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_HD_FILES),

	// Shadows on the Vatican - Act I: Greed (Legacy Version) (Steam, Jun 2018) (English)
	WME_WINENTRY_3D_FLAGS("sotv1", "Legacy Version/Steam",
		WME_ENTRY3s("data.dcp", "e0d5b1276cf80c858b7404f1f3381e2b", 95890675,
					"data_sd.dcp", "551feca25b9e0ac9d467c105efb373e8", 97979104,
					"i18n_en_strings.dcp", "733a53213ab5be27941c34dcef531e0e", 75119), Common::EN_ANY, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_HD_FILES),

	// Shadows on the Vatican - Act I: Greed (Legacy Version) (Steam, Jun 2018) (Spanish)
	WME_WINENTRY_3D_FLAGS("sotv1", "Legacy Version/Steam",
		WME_ENTRY3s("data.dcp", "e0d5b1276cf80c858b7404f1f3381e2b", 95890675,
					"data_sd.dcp", "551feca25b9e0ac9d467c105efb373e8", 97979104,
					"i18n_es_strings.dcp", "18876a252741b8bda888805ca860f600", 40153), Common::ES_ESP, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_HD_FILES),

	// Shadows on the Vatican - Act I: Greed (Legacy Version) (Steam, Jun 2018) (French)
	WME_WINENTRY_3D_FLAGS("sotv1", "Legacy Version/Steam",
		WME_ENTRY3s("data.dcp", "e0d5b1276cf80c858b7404f1f3381e2b", 95890675,
					"data_sd.dcp", "551feca25b9e0ac9d467c105efb373e8", 97979104,
					"i18n_fr_strings.dcp", "850cce9217d83785e4b56028441b0d71", 40807), Common::FR_FRA, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_HD_FILES),

	// Shadows on the Vatican - Act I: Greed (Legacy Version) (Steam, Jun 2018) (Italian)
	WME_WINENTRY_3D_FLAGS("sotv1", "Legacy Version/Steam",
		WME_ENTRY3s("data.dcp", "e0d5b1276cf80c858b7404f1f3381e2b", 95890675,
					"data_sd.dcp", "551feca25b9e0ac9d467c105efb373e8", 97979104,
					"i18n_it_strings.dcp", "de567598fba43589841c354306a80377", 40502), Common::IT_ITA, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_HD_FILES),

	// Shadows on the Vatican - Act I: Greed (Legacy Version) (Steam, Jun 2018) (Polish)
	WME_WINENTRY_3D_FLAGS("sotv1", "Legacy Version/Steam",
		WME_ENTRY3s("data.dcp", "e0d5b1276cf80c858b7404f1f3381e2b", 95890675,
					"data_sd.dcp", "551feca25b9e0ac9d467c105efb373e8", 97979104,
					"i18n_pl_strings.dcp", "daa4b251caec6c6e2c3b96aaf87ae33a", 40062), Common::PL_POL, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_HD_FILES),

	// Shadows on the Vatican - Act I: Greed (Legacy Version) (Steam, Jun 2018) (Russian)
	WME_WINENTRY_3D_FLAGS("sotv1", "Legacy Version/Steam",
		WME_ENTRY3s("data.dcp", "e0d5b1276cf80c858b7404f1f3381e2b", 95890675,
					"data_sd.dcp", "551feca25b9e0ac9d467c105efb373e8", 97979104,
					"i18n_ru_strings.dcp", "ebf28ca1475b3be9754a323966807683", 45546), Common::RU_RUS, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_HD_FILES),

	// Shadows on the Vatican - Act I: Greed (Full HD Version) (Steam, Jul 2014) (German)
	WME_WINENTRY_3D_FLAGS("sotv1", "Full HD Version/Steam",
		WME_ENTRY3s("data.dcp", "e19b63c6aa19d491a4f533ac9c1609ef", 97061505,
					"data_hd.dcp", "d8d903cbda2ff7001cc7ce949775897e", 197016744,
					"i18n_de_strings.dcp", "9cc009980d018476b177e2a4075f56b4", 43104), Common::DE_DEU, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_SD_FILES),

	// Shadows on the Vatican - Act I: Greed (Full HD Version) (Steam, Jul 2014) (English)
	WME_WINENTRY_3D_FLAGS("sotv1", "Full HD Version/Steam",
		WME_ENTRY3s("data.dcp", "e19b63c6aa19d491a4f533ac9c1609ef", 97061505,
					"data_hd.dcp", "d8d903cbda2ff7001cc7ce949775897e", 197016744,
					"i18n_en_strings.dcp", "40f8ea49a3e8d54a5202aa88c12fba80", 75108), Common::EN_ANY, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_SD_FILES),

	// Shadows on the Vatican - Act I: Greed (Full HD Version) (Steam, Jul 2014) (Spanish)
	WME_WINENTRY_3D_FLAGS("sotv1", "Full HD Version/Steam",
		WME_ENTRY3s("data.dcp", "e19b63c6aa19d491a4f533ac9c1609ef", 97061505,
					"data_hd.dcp", "d8d903cbda2ff7001cc7ce949775897e", 197016744,
					"i18n_es_strings.dcp", "6a8d5b434dfe758abb2ace1a75a4dab1", 40122), Common::ES_ESP, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_SD_FILES),

	// Shadows on the Vatican - Act I: Greed (Full HD Version) (Steam, Jul 2014) (French)
	WME_WINENTRY_3D_FLAGS("sotv1", "Full HD Version/Steam",
		WME_ENTRY3s("data.dcp", "e19b63c6aa19d491a4f533ac9c1609ef", 97061505,
					"data_hd.dcp", "d8d903cbda2ff7001cc7ce949775897e", 197016744,
					"i18n_fr_strings.dcp", "b3fe8c720bb6a5378f6da2f593339c70", 40760), Common::FR_FRA, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_SD_FILES),

	// Shadows on the Vatican - Act I: Greed (Full HD Version) (Steam, Jul 2014) (Italian)
	WME_WINENTRY_3D_FLAGS("sotv1", "Full HD Version/Steam",
		WME_ENTRY3s("data.dcp", "e19b63c6aa19d491a4f533ac9c1609ef", 97061505,
					"data_hd.dcp", "d8d903cbda2ff7001cc7ce949775897e", 197016744,
					"i18n_it_strings.dcp", "5abaab4d57d7585b3c4b23f34f2d0dd8", 40468), Common::IT_ITA, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_SD_FILES),
	...
	WME_WINENTRY_3D_FLAGS("sotv1", "Full HD Version/Steam",
		WME_ENTRY3s("data.dcp", "e382f34f0bd319ad310aba2ecd239dec", 95879376,
					...
					"i18n_de_strings.dcp", "780b0d8d4f2b2b32e729090c1018df43", 43136), Common::DE_DEU, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_SD_FILES),

	// Shadows on the Vatican - Act I: Greed (Full HD Version) (Steam, Feb 12th 2015) (English)
	WME_WINENTRY_3D_FLAGS("sotv1", "Full HD Version/Steam",
		WME_ENTRY3s("data.dcp", "e382f34f0bd319ad310aba2ecd239dec", 95879376,
					"data_hd.dcp", "1a077e884c659f34da61dd205591f83d", 197018612,
					"i18n_en_strings.dcp", "636e32cf89f02fca30a6f4caa38dede1", 75126), Common::EN_ANY, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_SD_FILES),

	// Shadows on the Vatican - Act I: Greed (Full HD Version) (Steam, Feb 12th 2015) (Spanish)
	WME_WINENTRY_3D_FLAGS("sotv1", "Full HD Version/Steam",
		WME_ENTRY3s("data.dcp", "e382f34f0bd319ad310aba2ecd239dec", 95879376,
					"data_hd.dcp", "1a077e884c659f34da61dd205591f83d", 197018612,
					"i18n_es_strings.dcp", "c62f94e9cd543ecbdc0f02acc744cd29", 40153), Common::ES_ESP, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_SD_FILES),

	// Shadows on the Vatican - Act I: Greed (Full HD Version) (Steam, Feb 12th 2015) (French)
	WME_WINENTRY_3D_FLAGS("sotv1", "Full HD Version/Steam",
		WME_ENTRY3s("data.dcp", "e382f34f0bd319ad310aba2ecd239dec", 95879376,
					"data_hd.dcp", "1a077e884c659f34da61dd205591f83d", 197018612,
					"i18n_fr_strings.dcp", "548e88d67be123bb54f5b265226f051a", 40807), Common::FR_FRA, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_SD_FILES),

	// Shadows on the Vatican - Act I: Greed (Full HD Version) (Steam, Feb 12th 2015) (Italian)
	WME_WINENTRY_3D_FLAGS("sotv1", "Full HD Version/Steam",
		WME_ENTRY3s("data.dcp", "e382f34f0bd319ad310aba2ecd239dec", 95879376,
					"data_hd.dcp", "1a077e884c659f34da61dd205591f83d", 197018612,
					"i18n_it_strings.dcp", "c3d180dd634705cb16ccd650066e1da8", 40502), Common::IT_ITA, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_SD_FILES),

	// Shadows on the Vatican - Act I: Greed (Full HD Version) (Steam, Feb 12th 2015) (Polish)
	WME_WINENTRY_3D_FLAGS("sotv1", "Full HD Version/Steam",
		WME_ENTRY3s("data.dcp", "e382f34f0bd319ad310aba2ecd239dec", 95879376,
					"data_hd.dcp", "1a077e884c659f34da61dd205591f83d", 197018612,
					"i18n_pl_strings.dcp", "8dac09efb73ae4a7a2b897de6f37e906", 40062), Common::PL_POL, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_SD_FILES),

	// Shadows on the Vatican - Act I: Greed (Full HD Version) (Steam, Feb 12th 2015) (Russian)
	WME_WINENTRY_3D_FLAGS("sotv1", "Full HD Version/Steam",
		WME_ENTRY3s("data.dcp", "e382f34f0bd319ad310aba2ecd239dec", 95879376,
					"data_hd.dcp", "1a077e884c659f34da61dd205591f83d", 197018612,
					"i18n_ru_strings.dcp", "88daa5c022c18535e2da86fa558db792", 45838), Common::RU_RUS, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_SD_FILES),
	...
	WME_WINENTRY_3D_FLAGS("sotv1", "Full HD Version/Steam",
		WME_ENTRY3s("data.dcp", "bb6136d76ebadf06c90877283aa1d55a", 95890682,
					...
					"i18n_de_strings.dcp", "d245d247a282cda33b83ed6918b2e6d5", 43136), Common::DE_DEU, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_SD_FILES),

	// Shadows on the Vatican - Act I: Greed (Full HD Version) (Steam, Feb 22th 2015) (English)
	WME_WINENTRY_3D_FLAGS("sotv1", "Full HD Version/Steam",
		WME_ENTRY3s("data.dcp", "bb6136d76ebadf06c90877283aa1d55a", 95890682,
					"data_hd.dcp", "bfd3bc963c073af866e5405d6d5f1347", 197125364,
					"i18n_en_strings.dcp", "5e9cf5a8403b98f7d92de55efccc0d34", 75119), Common::EN_ANY, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_SD_FILES),

	// Shadows on the Vatican - Act I: Greed (Full HD Version) (Steam, Feb 22th 2015) (Spanish)
	WME_WINENTRY_3D_FLAGS("sotv1", "Full HD Version/Steam",
		WME_ENTRY3s("data.dcp", "bb6136d76ebadf06c90877283aa1d55a", 95890682,
					"data_hd.dcp", "bfd3bc963c073af866e5405d6d5f1347", 197125364,
					"i18n_es_strings.dcp", "edb19a0758243da8929844bac035d384", 40153), Common::ES_ESP, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_SD_FILES),

	// Shadows on the Vatican - Act I: Greed (Full HD Version) (Steam, Feb 22th 2015) (French)
	WME_WINENTRY_3D_FLAGS("sotv1", "Full HD Version/Steam",
		WME_ENTRY3s("data.dcp", "bb6136d76ebadf06c90877283aa1d55a", 95890682,
					"data_hd.dcp", "bfd3bc963c073af866e5405d6d5f1347", 197125364,
					"i18n_fr_strings.dcp", "40dda8156fa93717cf962e75d76929b1", 40807), Common::FR_FRA, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_SD_FILES),

	// Shadows on the Vatican - Act I: Greed (Full HD Version) (Steam, Feb 22th 2015) (Italian)
	WME_WINENTRY_3D_FLAGS("sotv1", "Full HD Version/Steam",
		WME_ENTRY3s("data.dcp", "bb6136d76ebadf06c90877283aa1d55a", 95890682,
					"data_hd.dcp", "bfd3bc963c073af866e5405d6d5f1347", 197125364,
					"i18n_it_strings.dcp", "0d1dac14379e55356794fb7cca8865b2", 40502), Common::IT_ITA, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_SD_FILES),

	// Shadows on the Vatican - Act I: Greed (Full HD Version) (Steam, Feb 22th 2015) (Polish)
	WME_WINENTRY_3D_FLAGS("sotv1", "Full HD Version/Steam",
		WME_ENTRY3s("data.dcp", "bb6136d76ebadf06c90877283aa1d55a", 95890682,
					"data_hd.dcp", "bfd3bc963c073af866e5405d6d5f1347", 197125364,
					"i18n_pl_strings.dcp", "cdd0b203c591dfb411cb6fc89ac009c1", 40062), Common::PL_POL, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_SD_FILES),

	// Shadows on the Vatican - Act I: Greed (Full HD Version) (Steam, Feb 22th 2015) (Russian)
	WME_WINENTRY_3D_FLAGS("sotv1", "Full HD Version/Steam",
		WME_ENTRY3s("data.dcp", "bb6136d76ebadf06c90877283aa1d55a", 95890682,
					"data_hd.dcp", "bfd3bc963c073af866e5405d6d5f1347", 197125364,
					"i18n_ru_strings.dcp", "77fc889bb25438bafe897d1566bd7e50", 45546), Common::RU_RUS, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_SD_FILES),
	...
	WME_WINENTRY_3D_FLAGS("sotv1", "Full HD Version/Steam",
		WME_ENTRY3s("data.dcp", "46bb5822abf6d422d08a68070e05bd86", 95890675,
					...
					"i18n_de_strings.dcp", "94230807d77dacb420f446c34dd60072", 43136), Common::DE_DEU, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_SD_FILES),

	// Shadows on the Vatican - Act I: Greed (Full HD Version) (Steam, Sep 2016) (English)
	WME_WINENTRY_3D_FLAGS("sotv1", "Full HD Version/Steam",
		WME_ENTRY3s("data.dcp", "46bb5822abf6d422d08a68070e05bd86", 95890675,
					"data_hd.dcp", "79a5c4ae560817a149506dce894274d0", 197155130,
					"i18n_en_strings.dcp", "253e7f5e2bb4a33c7df52a04624d18c6", 75119), Common::EN_ANY, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_SD_FILES),

	// Shadows on the Vatican - Act I: Greed (Full HD Version) (Steam, Sep 2016) (Spanish)
	WME_WINENTRY_3D_FLAGS("sotv1", "Full HD Version/Steam",
		WME_ENTRY3s("data.dcp", "46bb5822abf6d422d08a68070e05bd86", 95890675,
					"data_hd.dcp", "79a5c4ae560817a149506dce894274d0", 197155130,
					"i18n_es_strings.dcp", "2227cee67309f564178e48d3eb30fc98", 40153), Common::ES_ESP, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_SD_FILES),

	// Shadows on the Vatican - Act I: Greed (Full HD Version) (Steam, Sep 2016) (French)
	WME_WINENTRY_3D_FLAGS("sotv1", "Full HD Version/Steam",
		WME_ENTRY3s("data.dcp", "46bb5822abf6d422d08a68070e05bd86", 95890675,
					"data_hd.dcp", "79a5c4ae560817a149506dce894274d0", 197155130,
					"i18n_fr_strings.dcp", "f50d251df43e5433b9664d5c2463fb08", 40807), Common::FR_FRA, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_SD_FILES),

	// Shadows on the Vatican - Act I: Greed (Full HD Version) (Steam, Sep 2016) (Italian)
	WME_WINENTRY_3D_FLAGS("sotv1", "Full HD Version/Steam",
		WME_ENTRY3s("data.dcp", "46bb5822abf6d422d08a68070e05bd86", 95890675,
					"data_hd.dcp", "79a5c4ae560817a149506dce894274d0", 197155130,
					"i18n_it_strings.dcp", "6ad0d7c0a0c450d6af334cd1b4dbe72e", 40502), Common::IT_ITA, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_SD_FILES),

	// Shadows on the Vatican - Act I: Greed (Full HD Version) (Steam, Sep 2016) (Polish)
	WME_WINENTRY_3D_FLAGS("sotv1", "Full HD Version/Steam",
		WME_ENTRY3s("data.dcp", "46bb5822abf6d422d08a68070e05bd86", 95890675,
					"data_hd.dcp", "79a5c4ae560817a149506dce894274d0", 197155130,
					"i18n_pl_strings.dcp", "7c07fb021517dd21ba2e2a5739d0168e", 40062), Common::PL_POL, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_SD_FILES),

	// Shadows on the Vatican - Act I: Greed (Full HD Version) (Steam, Sep 2016) (Russian)
	WME_WINENTRY_3D_FLAGS("sotv1", "Full HD Version/Steam",
		WME_ENTRY3s("data.dcp", "46bb5822abf6d422d08a68070e05bd86", 95890675,
					"data_hd.dcp", "79a5c4ae560817a149506dce894274d0", 197155130,
					"i18n_ru_strings.dcp", "5cecc876ec1b364f22780d18a0821349", 45546), Common::RU_RUS, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_SD_FILES),
	...
	WME_WINENTRY_3D_FLAGS("sotv1", "Full HD Version/Steam",
		WME_ENTRY3s("data.dcp", "e0d5b1276cf80c858b7404f1f3381e2b", 95890675,
					...
					"i18n_de_strings.dcp", "59d15bb3c32354b5104475df0ff6c50b", 43136), Common::DE_DEU, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_SD_FILES),

	// Shadows on the Vatican - Act I: Greed (Full HD Version) (Steam, Jun 2018) (English)
	WME_WINENTRY_3D_FLAGS("sotv1", "Full HD Version/Steam",
		WME_ENTRY3s("data.dcp", "e0d5b1276cf80c858b7404f1f3381e2b", 95890675,
					"data_hd.dcp", "05ce36b4c7b947c503496a1d895671e5", 197431006,
					"i18n_en_strings.dcp", "733a53213ab5be27941c34dcef531e0e", 75119), Common::EN_ANY, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_SD_FILES),

	// Shadows on the Vatican - Act I: Greed (Full HD Version) (Steam, Jun 2018) (Spanish)
	WME_WINENTRY_3D_FLAGS("sotv1", "Full HD Version/Steam",
		WME_ENTRY3s("data.dcp", "e0d5b1276cf80c858b7404f1f3381e2b", 95890675,
					"data_hd.dcp", "05ce36b4c7b947c503496a1d895671e5", 197431006,
					"i18n_es_strings.dcp", "18876a252741b8bda888805ca860f600", 40153), Common::ES_ESP, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_SD_FILES),

	// Shadows on the Vatican - Act I: Greed (Full HD Version) (Steam, Jun 2018) (French)
	WME_WINENTRY_3D_FLAGS("sotv1", "Full HD Version/Steam",
		WME_ENTRY3s("data.dcp", "e0d5b1276cf80c858b7404f1f3381e2b", 95890675,
					"data_hd.dcp", "05ce36b4c7b947c503496a1d895671e5", 197431006,
					"i18n_fr_strings.dcp", "850cce9217d83785e4b56028441b0d71", 40807), Common::FR_FRA, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_SD_FILES),

	// Shadows on the Vatican - Act I: Greed (Full HD Version) (Steam, Jun 2018) (Italian)
	WME_WINENTRY_3D_FLAGS("sotv1", "Full HD Version/Steam",
		WME_ENTRY3s("data.dcp", "e0d5b1276cf80c858b7404f1f3381e2b", 95890675,
					"data_hd.dcp", "05ce36b4c7b947c503496a1d895671e5", 197431006,
					"i18n_it_strings.dcp", "de567598fba43589841c354306a80377", 40502), Common::IT_ITA, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_SD_FILES),

	// Shadows on the Vatican - Act I: Greed (Full HD Version) (Steam, Jun 2018) (Polish)
	WME_WINENTRY_3D_FLAGS("sotv1", "Full HD Version/Steam",
		WME_ENTRY3s("data.dcp", "e0d5b1276cf80c858b7404f1f3381e2b", 95890675,
					"data_hd.dcp", "05ce36b4c7b947c503496a1d895671e5", 197431006,
					"i18n_pl_strings.dcp", "daa4b251caec6c6e2c3b96aaf87ae33a", 40062), Common::PL_POL, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_SD_FILES),

	// Shadows on the Vatican - Act I: Greed (Full HD Version) (Steam, Jun 2018) (Russian)
	WME_WINENTRY_3D_FLAGS("sotv1", "Full HD Version/Steam",
		WME_ENTRY3s("data.dcp", "e0d5b1276cf80c858b7404f1f3381e2b", 95890675,
					"data_hd.dcp", "05ce36b4c7b947c503496a1d895671e5", 197431006,
					"i18n_ru_strings.dcp", "ebf28ca1475b3be9754a323966807683", 45546), Common::RU_RUS, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_SD_FILES),

	// Shadows on the Vatican - Act I: Greed (Legacy Version) (NewTech) (Persian)
	// NOTE: this game distribution contained unpacked game files instead of usual game.dcp package
	WME_WINENTRY_3D("sotv1", "Legacy Version",
		WME_ENTRY1s("default.game", "2631e8ba12cdd7ef08c5ee72391ad703", 968), Common::FA_IRN, ADGF_UNSTABLE, WME_1_9_1),

	// Shadows on the Vatican - Act II: Wrath (Legacy Version) (Steam, Oct 26th 2015) (English)
	WME_WINENTRY_3D_FLAGS("sotv2", "Legacy Version/Steam",
		WME_ENTRY3s("data.dcp", "cfea0d6c7e4a96627d16887c3480266a", 273132663,
					"data_sd.dcp", "bd51d2a1e662bd9ed3af7aa1f2180900", 91701364,
					"i18n_en_strings.dcp", "33db4beabfe9813f16133c97198b7520", 114808), Common::EN_ANY, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_HD_FILES),

	// Shadows on the Vatican - Act II: Wrath (Legacy Version) (Steam, Oct 26th 2015) (Italian)
	WME_WINENTRY_3D_FLAGS("sotv2", "Legacy Version/Steam",
		WME_ENTRY3s("data.dcp", "cfea0d6c7e4a96627d16887c3480266a", 273132663,
					"data_sd.dcp", "bd51d2a1e662bd9ed3af7aa1f2180900", 91701364,
					"i18n_it_strings.dcp", "1fefff6f0fb87abe9acf88da9af1a8e7", 127306), Common::IT_ITA, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_HD_FILES),

	// Shadows on the Vatican - Act II: Wrath (Legacy Version) (Steam, Oct 26th 2015) (German)
	WME_WINENTRY_3D_FLAGS("sotv2", "Legacy Version/Steam",
		WME_ENTRY3s("data.dcp", "cfea0d6c7e4a96627d16887c3480266a", 273132663,
					"data_sd.dcp", "bd51d2a1e662bd9ed3af7aa1f2180900", 91701364,
					"i18n_de_strings.dcp", "30a2d7f796b3924af7e77e28f52a18b0", 60239), Common::DE_DEU, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_HD_FILES),

	// Shadows on the Vatican - Act II: Wrath (Legacy Version) (Steam, Oct 29th 2015) (German)
	WME_WINENTRY_3D_FLAGS("sotv2", "Legacy Version/Steam",
		WME_ENTRY3s("data.dcp", "cfea0d6c7e4a96627d16887c3480266a", 273132663,
					"data_sd.dcp", "bd51d2a1e662bd9ed3af7aa1f2180900", 91701364,
					"i18n_de_strings.dcp", "1159db7384da56aae6953d1b943e4c57", 60737), Common::DE_DEU, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_HD_FILES),

	// Shadows on the Vatican - Act II: Wrath (Legacy Version) (Steam, Oct 26th 2015) (French)
	WME_WINENTRY_3D_FLAGS("sotv2", "Legacy Version/Steam",
		WME_ENTRY3s("data.dcp", "cfea0d6c7e4a96627d16887c3480266a", 273132663,
					"data_sd.dcp", "bd51d2a1e662bd9ed3af7aa1f2180900", 91701364,
					"i18n_fr_strings.dcp", "0ce3927e47f9ed8ca6668d0728508abb", 59087), Common::FR_FRA, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_HD_FILES),

	// Shadows on the Vatican - Act II: Wrath (Legacy Version) (Steam, Oct 26th 2015) (Russian)
	WME_WINENTRY_3D_FLAGS("sotv2", "Legacy Version/Steam",
		WME_ENTRY3s("data.dcp", "cfea0d6c7e4a96627d16887c3480266a", 273132663,
					"data_sd.dcp", "bd51d2a1e662bd9ed3af7aa1f2180900", 91701364,
					"i18n_ru_strings.dcp", "20aebb86e857f213fd46d24fba3f6b9c", 73828), Common::RU_RUS, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_HD_FILES),

	// Shadows on the Vatican - Act II: Wrath (Legacy Version) (Steam, Oct 26th 2015) (Polish)
	WME_WINENTRY_3D_FLAGS("sotv2", "Legacy Version/Steam",
		WME_ENTRY3s("data.dcp", "cfea0d6c7e4a96627d16887c3480266a", 273132663,
					"data_sd.dcp", "bd51d2a1e662bd9ed3af7aa1f2180900", 91701364,
					"i18n_pl_strings.dcp", "cc5e50a22672c17211008b6f710e2009", 119066), Common::PL_POL, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_HD_FILES),
	...
	WME_WINENTRY_3D_FLAGS("sotv2", "Legacy Version/Steam",
		WME_ENTRY3s("data.dcp", "e499fac283cf68c6a85638415c4ec083", 273132663,
					...
					"i18n_en_strings.dcp", "fe5b2bb6dd91bbac101f61f388ae8e09", 114808), Common::EN_ANY, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_HD_FILES),

	// Shadows on the Vatican - Act II: Wrath (Legacy Version) (Steam, Oct 31th 2015) (Italian)
	WME_WINENTRY_3D_FLAGS("sotv2", "Legacy Version/Steam",
		WME_ENTRY3s("data.dcp", "e499fac283cf68c6a85638415c4ec083", 273132663,
					"data_sd.dcp", "f9d1bb722eee17696c1c9266d6905924", 91701364,
					"i18n_it_strings.dcp", "cf17089a0c047e7521c4da4a534b0c75", 127245), Common::IT_ITA, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_HD_FILES),

	// Shadows on the Vatican - Act II: Wrath (Legacy Version) (Steam, Oct 31th 2015) (German)
	WME_WINENTRY_3D_FLAGS("sotv2", "Legacy Version/Steam",
		WME_ENTRY3s("data.dcp", "e499fac283cf68c6a85638415c4ec083", 273132663,
					"data_sd.dcp", "f9d1bb722eee17696c1c9266d6905924", 91701364,
					"i18n_de_strings.dcp", "e0285a53d947e6e6925094604d011d3c", 60728), Common::DE_DEU, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_HD_FILES),

	// Shadows on the Vatican - Act II: Wrath (Legacy Version) (Steam, Oct 31th 2015) (French)
	WME_WINENTRY_3D_FLAGS("sotv2", "Legacy Version/Steam",
		WME_ENTRY3s("data.dcp", "e499fac283cf68c6a85638415c4ec083", 273132663,
					"data_sd.dcp", "f9d1bb722eee17696c1c9266d6905924", 91701364,
					"i18n_fr_strings.dcp", "9155180fb4b3a727a5ae58555e77fe0f", 59087), Common::FR_FRA, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_HD_FILES),

	// Shadows on the Vatican - Act II: Wrath (Legacy Version) (Steam, Oct 31th 2015) (Russian)
	WME_WINENTRY_3D_FLAGS("sotv2", "Legacy Version/Steam",
		WME_ENTRY3s("data.dcp", "e499fac283cf68c6a85638415c4ec083", 273132663,
					"data_sd.dcp", "f9d1bb722eee17696c1c9266d6905924", 91701364,
					"i18n_ru_strings.dcp", "decc382f1e1c382e43f7a65f76177cc6", 73757), Common::RU_RUS, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_HD_FILES),

	// Shadows on the Vatican - Act II: Wrath (Legacy Version) (Steam, Oct 31th 2015) (Polish)
	WME_WINENTRY_3D_FLAGS("sotv2", "Legacy Version/Steam",
		WME_ENTRY3s("data.dcp", "e499fac283cf68c6a85638415c4ec083", 273132663,
					"data_sd.dcp", "f9d1bb722eee17696c1c9266d6905924", 91701364,
					"i18n_pl_strings.dcp", "70e7aac260fc6e114b9a52a163276889", 119066), Common::PL_POL, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_HD_FILES),
	...
	WME_WINENTRY_3D_FLAGS("sotv2", "Legacy Version/Steam",
		WME_ENTRY3s("data.dcp", "8c9aa3c3d705f61c753e2f54f3104b8e", 273131920,
					...
					"i18n_en_strings.dcp", "b53006a80b7c7c6c40d69ee4ac6eab0e", 114808), Common::EN_ANY, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_HD_FILES),

	// Shadows on the Vatican - Act II: Wrath (Legacy Version) (Steam, Nov 2015) (Italian)
	WME_WINENTRY_3D_FLAGS("sotv2", "Legacy Version/Steam",
		WME_ENTRY3s("data.dcp", "8c9aa3c3d705f61c753e2f54f3104b8e", 273131920,
					"data_sd.dcp", "570aec5b2ceeea6e3d327b54b183d46b", 91702107,
					"i18n_it_strings.dcp", "4c84c9662e758c14a127130e20895f65", 127245), Common::IT_ITA, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_HD_FILES),

	// Shadows on the Vatican - Act II: Wrath (Legacy Version) (Steam, Nov 2015) (German)
	WME_WINENTRY_3D_FLAGS("sotv2", "Legacy Version/Steam",
		WME_ENTRY3s("data.dcp", "8c9aa3c3d705f61c753e2f54f3104b8e", 273131920,
					"data_sd.dcp", "570aec5b2ceeea6e3d327b54b183d46b", 91702107,
					"i18n_de_strings.dcp", "3a454226e403b32ac3b16a15711afe3f", 60728), Common::DE_DEU, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_HD_FILES),

	// Shadows on the Vatican - Act II: Wrath (Legacy Version) (Steam, Nov 2015) (French)
	WME_WINENTRY_3D_FLAGS("sotv2", "Legacy Version/Steam",
		WME_ENTRY3s("data.dcp", "8c9aa3c3d705f61c753e2f54f3104b8e", 273131920,
					"data_sd.dcp", "570aec5b2ceeea6e3d327b54b183d46b", 91702107,
					"i18n_fr_strings.dcp", "b2c65cef26a889663e7311a15796469b", 59087), Common::FR_FRA, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_HD_FILES),

	// Shadows on the Vatican - Act II: Wrath (Legacy Version) (Steam, Nov 2015) (Russian)
	WME_WINENTRY_3D_FLAGS("sotv2", "Legacy Version/Steam",
		WME_ENTRY3s("data.dcp", "8c9aa3c3d705f61c753e2f54f3104b8e", 273131920,
					"data_sd.dcp", "570aec5b2ceeea6e3d327b54b183d46b", 91702107,
					"i18n_ru_strings.dcp", "d9efa7d1d872f81d4d8602d5b4eb4f70", 73757), Common::RU_RUS, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_HD_FILES),

	// Shadows on the Vatican - Act II: Wrath (Legacy Version) (Steam, Nov 2015) (Polish)
	WME_WINENTRY_3D_FLAGS("sotv2", "Legacy Version/Steam",
		WME_ENTRY3s("data.dcp", "8c9aa3c3d705f61c753e2f54f3104b8e", 273131920,
					"data_sd.dcp", "570aec5b2ceeea6e3d327b54b183d46b", 91702107,
					"i18n_pl_strings.dcp", "31da3aa3c184282290f5e418e6412eb3", 119066), Common::PL_POL, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_HD_FILES),
	...
	WME_WINENTRY_3D_FLAGS("sotv2", "Legacy Version/Steam",
		WME_ENTRY3s("data.dcp", "988f6f424110bf0d88b9c8066809df84", 273131920,
					...
					"i18n_en_strings.dcp", "699872d03e5c379299d1cd75894c6ef5", 114808), Common::EN_ANY, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_HD_FILES),

	// Shadows on the Vatican - Act II: Wrath (Legacy Version) (Steam, Jan 2016) (Italian)
	WME_WINENTRY_3D_FLAGS("sotv2", "Legacy Version/Steam",
		WME_ENTRY3s("data.dcp", "988f6f424110bf0d88b9c8066809df84", 273131920,
					"data_sd.dcp", "30e5c1bd6e98485886c0e8c665510897", 91702107,
					"i18n_it_strings.dcp", "fd8a38801ff03401447e9507965841b2", 127245), Common::IT_ITA, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_HD_FILES),

	// Shadows on the Vatican - Act II: Wrath (Legacy Version) (Steam, Jan 2016) (German)
	WME_WINENTRY_3D_FLAGS("sotv2", "Legacy Version/Steam",
		WME_ENTRY3s("data.dcp", "988f6f424110bf0d88b9c8066809df84", 273131920,
					"data_sd.dcp", "30e5c1bd6e98485886c0e8c665510897", 91702107,
					"i18n_de_strings.dcp", "56057bb46e86965e2b5d5ca7823baad5", 60235), Common::DE_DEU, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_HD_FILES),

	// Shadows on the Vatican - Act II: Wrath (Legacy Version) (Steam, Jan 2016) (French)
	WME_WINENTRY_3D_FLAGS("sotv2", "Legacy Version/Steam",
		WME_ENTRY3s("data.dcp", "988f6f424110bf0d88b9c8066809df84", 273131920,
					"data_sd.dcp", "30e5c1bd6e98485886c0e8c665510897", 91702107,
					"i18n_fr_strings.dcp", "29a3a13a8bf787c0811eba67f7c59b41", 59087), Common::FR_FRA, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_HD_FILES),

	// Shadows on the Vatican - Act II: Wrath (Legacy Version) (Steam, Jan 2016) (Russian)
	WME_WINENTRY_3D_FLAGS("sotv2", "Legacy Version/Steam",
		WME_ENTRY3s("data.dcp", "988f6f424110bf0d88b9c8066809df84", 273131920,
					"data_sd.dcp", "30e5c1bd6e98485886c0e8c665510897", 91702107,
					"i18n_ru_strings.dcp", "92ddba944cc23ad12122bf571ac6b856", 73757), Common::RU_RUS, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_HD_FILES),

	// Shadows on the Vatican - Act II: Wrath (Legacy Version) (Steam, Jan 2016) (Polish)
	WME_WINENTRY_3D_FLAGS("sotv2", "Legacy Version/Steam",
		WME_ENTRY3s("data.dcp", "988f6f424110bf0d88b9c8066809df84", 273131920,
					"data_sd.dcp", "30e5c1bd6e98485886c0e8c665510897", 91702107,
					"i18n_pl_strings.dcp", "a3729952b1e24d2d4367dd07a735235b", 119066), Common::PL_POL, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_HD_FILES),
	...
	WME_WINENTRY_3D_FLAGS("sotv2", "Legacy Version/Steam",
		WME_ENTRY3s("data.dcp", "208df61df9b95c9d9d0107877eb2f4d7", 273131926,
					...
					"i18n_en_strings.dcp", "6a389c7509da41c4e15b63a7c0530243", 114808), Common::EN_ANY, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_HD_FILES),

	// Shadows on the Vatican - Act II: Wrath (Legacy Version) (Steam, May 2016) (Italian)
	WME_WINENTRY_3D_FLAGS("sotv2", "Legacy Version/Steam",
		WME_ENTRY3s("data.dcp", "208df61df9b95c9d9d0107877eb2f4d7", 273131926,
					"data_sd.dcp", "ff35bbc26334a58b3b4da6d828d69ac2", 94358335,
					"i18n_it_strings.dcp", "6222689f42ea2948e3d38e537710383f", 127239), Common::IT_ITA, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_HD_FILES),

	// Shadows on the Vatican - Act II: Wrath (Legacy Version) (Steam, May 2016) (German)
	WME_WINENTRY_3D_FLAGS("sotv2", "Legacy Version/Steam",
		WME_ENTRY3s("data.dcp", "208df61df9b95c9d9d0107877eb2f4d7", 273131926,
					"data_sd.dcp", "ff35bbc26334a58b3b4da6d828d69ac2", 94358335,
					"i18n_de_strings.dcp", "975928849951229f497de36e1a707b61", 60230), Common::DE_DEU, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_HD_FILES),

	// Shadows on the Vatican - Act II: Wrath (Legacy Version) (Steam, May 2016) (Spanish)
	WME_WINENTRY_3D_FLAGS("sotv2", "Legacy Version/Steam",
		WME_ENTRY3s("data.dcp", "208df61df9b95c9d9d0107877eb2f4d7", 273131926,
					"data_sd.dcp", "ff35bbc26334a58b3b4da6d828d69ac2", 94358335,
					"i18n_es_strings.dcp", "83d88a4b2e5da2a40ac981fcfa9a95bc", 55013), Common::ES_ESP, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_HD_FILES),

	// Shadows on the Vatican - Act II: Wrath (Legacy Version) (Steam, May 2016) (French)
	WME_WINENTRY_3D_FLAGS("sotv2", "Legacy Version/Steam",
		WME_ENTRY3s("data.dcp", "208df61df9b95c9d9d0107877eb2f4d7", 273131926,
					"data_sd.dcp", "ff35bbc26334a58b3b4da6d828d69ac2", 94358335,
					"i18n_fr_strings.dcp", "6bfc2f1753141e28d22756d9768f4d44", 59086), Common::FR_FRA, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_HD_FILES),

	// Shadows on the Vatican - Act II: Wrath (Legacy Version) (Steam, May 2016) (Russian)
	WME_WINENTRY_3D_FLAGS("sotv2", "Legacy Version/Steam",
		WME_ENTRY3s("data.dcp", "208df61df9b95c9d9d0107877eb2f4d7", 273131926,
					"data_sd.dcp", "ff35bbc26334a58b3b4da6d828d69ac2", 94358335,
					"i18n_ru_strings.dcp", "e85982376d9fb1c21e1acc8272b49412", 73757), Common::RU_RUS, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_HD_FILES),

	// Shadows on the Vatican - Act II: Wrath (Legacy Version) (Steam, May 2016) (Polish)
	WME_WINENTRY_3D_FLAGS("sotv2", "Legacy Version/Steam",
		WME_ENTRY3s("data.dcp", "208df61df9b95c9d9d0107877eb2f4d7", 273131926,
					"data_sd.dcp", "ff35bbc26334a58b3b4da6d828d69ac2", 94358335,
					"i18n_pl_strings.dcp", "5ba1e92f1fc762ecec74104f4588ba04", 119066), Common::PL_POL, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_HD_FILES),
	...
	WME_WINENTRY_3D_FLAGS("sotv2", "Legacy Version/Steam",
		WME_ENTRY3s("data.dcp", "73b14ef68eecd41afbe39c2c4f671986", 273131946,
					...
					"i18n_en_strings.dcp", "250626c49627e5f3f18883d6eb71e869", 114808), Common::EN_ANY, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_HD_FILES),

	// Shadows on the Vatican - Act II: Wrath (Legacy Version) (Steam, Sep 2016) (Italian)
	WME_WINENTRY_3D_FLAGS("sotv2", "Legacy Version/Steam",
		WME_ENTRY3s("data.dcp", "73b14ef68eecd41afbe39c2c4f671986", 273131946,
					"data_sd.dcp", "f06a138b758e888f030ce659a42a6e31", 97327255,
					"i18n_it_strings.dcp", "338be9aa9c611e349ab7c0a4065a6c78", 127241), Common::IT_ITA, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_HD_FILES),

	// Shadows on the Vatican - Act II: Wrath (Legacy Version) (Steam, Sep 2016) (German)
	WME_WINENTRY_3D_FLAGS("sotv2", "Legacy Version/Steam",
		WME_ENTRY3s("data.dcp", "73b14ef68eecd41afbe39c2c4f671986", 273131946,
					"data_sd.dcp", "f06a138b758e888f030ce659a42a6e31", 97327255,
					"i18n_de_strings.dcp", "46811e68b29fd07e115343e17c53f676", 60429), Common::DE_DEU, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_HD_FILES),

	// Shadows on the Vatican - Act II: Wrath (Legacy Version) (Steam, Sep 2016) (Spanish)
	WME_WINENTRY_3D_FLAGS("sotv2", "Legacy Version/Steam",
		WME_ENTRY3s("data.dcp", "73b14ef68eecd41afbe39c2c4f671986", 273131946,
					"data_sd.dcp", "f06a138b758e888f030ce659a42a6e31", 97327255,
					"i18n_es_strings.dcp", "61e518d05b62a48827ce6fa0a95e8021", 54964), Common::ES_ESP, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_HD_FILES),

	// Shadows on the Vatican - Act II: Wrath (Legacy Version) (Steam, Sep 2016) (French)
	WME_WINENTRY_3D_FLAGS("sotv2", "Legacy Version/Steam",
		WME_ENTRY3s("data.dcp", "73b14ef68eecd41afbe39c2c4f671986", 273131946,
					"data_sd.dcp", "f06a138b758e888f030ce659a42a6e31", 97327255,
					"i18n_fr_strings.dcp", "4605094d334272dd2bc3ba3203b36c48", 59086), Common::FR_FRA, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_HD_FILES),

	// Shadows on the Vatican - Act II: Wrath (Legacy Version) (Steam, Sep 2016) (Russian)
	WME_WINENTRY_3D_FLAGS("sotv2", "Legacy Version/Steam",
		WME_ENTRY3s("data.dcp", "73b14ef68eecd41afbe39c2c4f671986", 273131946,
					"data_sd.dcp", "f06a138b758e888f030ce659a42a6e31", 97327255,
					"i18n_ru_strings.dcp", "8a948c77f185feac630600e3d8f55195", 73757), Common::RU_RUS, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_HD_FILES),

	// Shadows on the Vatican - Act II: Wrath (Legacy Version) (Steam, Sep 2016) (Polish)
	WME_WINENTRY_3D_FLAGS("sotv2", "Legacy Version/Steam",
		WME_ENTRY3s("data.dcp", "73b14ef68eecd41afbe39c2c4f671986", 273131946,
					"data_sd.dcp", "f06a138b758e888f030ce659a42a6e31", 97327255,
					"i18n_pl_strings.dcp", "4a07c25e2d082320880536cc2a835868", 119077), Common::PL_POL, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_HD_FILES),
	...
	WME_WINENTRY_3D_FLAGS("sotv2", "Legacy Version/Steam",
		WME_ENTRY3s("data.dcp", "f04bc0d4fb2034adea3e7f9652b617ec", 273131946,
					...
					"i18n_en_strings.dcp", "db0db417d6dc8c70de625ee7520d5e40", 114808), Common::EN_ANY, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_HD_FILES),

	// Shadows on the Vatican - Act II: Wrath (Legacy Version) (Steam, Oct 2016) (Italian)
	WME_WINENTRY_3D_FLAGS("sotv2", "Legacy Version/Steam",
		WME_ENTRY3s("data.dcp", "f04bc0d4fb2034adea3e7f9652b617ec", 273131946,
					"data_sd.dcp", "eedb6e8addffd6cd882f18b231e439a4", 97327255,
					"i18n_it_strings.dcp", "809c993d42983fe8664a628804cba98e", 127241), Common::IT_ITA, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_HD_FILES),

	// Shadows on the Vatican - Act II: Wrath (Legacy Version) (Steam, Oct 2016) (German)
	WME_WINENTRY_3D_FLAGS("sotv2", "Legacy Version/Steam",
		WME_ENTRY3s("data.dcp", "f04bc0d4fb2034adea3e7f9652b617ec", 273131946,
					"data_sd.dcp", "eedb6e8addffd6cd882f18b231e439a4", 97327255,
					"i18n_de_strings.dcp", "e6570cb5365d6122e0ac549f83945a9f", 60429), Common::DE_DEU, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_HD_FILES),

	// Shadows on the Vatican - Act II: Wrath (Legacy Version) (Steam, Oct 2016) (Spanish)
	WME_WINENTRY_3D_FLAGS("sotv2", "Legacy Version/Steam",
		WME_ENTRY3s("data.dcp", "f04bc0d4fb2034adea3e7f9652b617ec", 273131946,
					"data_sd.dcp", "eedb6e8addffd6cd882f18b231e439a4", 97327255,
					"i18n_es_strings.dcp", "c06845d464212b022c7eee21cc6502d1", 54964), Common::ES_ESP, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_HD_FILES),

	// Shadows on the Vatican - Act II: Wrath (Legacy Version) (Steam, Oct 2016) (French)
	WME_WINENTRY_3D_FLAGS("sotv2", "Legacy Version/Steam",
		WME_ENTRY3s("data.dcp", "f04bc0d4fb2034adea3e7f9652b617ec", 273131946,
					"data_sd.dcp", "eedb6e8addffd6cd882f18b231e439a4", 97327255,
					"i18n_fr_strings.dcp", "47ff2736401cde872ef454f41a5216ec", 59086), Common::FR_FRA, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_HD_FILES),

	// Shadows on the Vatican - Act II: Wrath (Legacy Version) (Steam, Oct 2016) (Russian)
	WME_WINENTRY_3D_FLAGS("sotv2", "Legacy Version/Steam",
		WME_ENTRY3s("data.dcp", "f04bc0d4fb2034adea3e7f9652b617ec", 273131946,
					"data_sd.dcp", "eedb6e8addffd6cd882f18b231e439a4", 97327255,
					"i18n_ru_strings.dcp", "5ffe06a72c914d287878f2f018109f04", 73757), Common::RU_RUS, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_HD_FILES),

	// Shadows on the Vatican - Act II: Wrath (Legacy Version) (Steam, Oct 2016) (Polish)
	WME_WINENTRY_3D_FLAGS("sotv2", "Legacy Version/Steam",
		WME_ENTRY3s("data.dcp", "f04bc0d4fb2034adea3e7f9652b617ec", 273131946,
					"data_sd.dcp", "eedb6e8addffd6cd882f18b231e439a4", 97327255,
					"i18n_pl_strings.dcp", "43df37eaa12d9a60561297a199ba0e70", 119077), Common::PL_POL, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_HD_FILES),
	...
	WME_WINENTRY_3D_FLAGS("sotv2", "Legacy Version/Steam",
		WME_ENTRY3s("data.dcp", "0410ed71d9d6f133c703009edab38da4", 273131997,
					...
					"i18n_en_strings.dcp", "4b6a631516bd9bd1aa20028b0c7266bd", 114808), Common::EN_ANY, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_HD_FILES),

	// Shadows on the Vatican - Act II: Wrath (Legacy Version) (Steam, Jun 2018) (Italian)
	WME_WINENTRY_3D_FLAGS("sotv2", "Legacy Version/Steam",
		WME_ENTRY3s("data.dcp", "0410ed71d9d6f133c703009edab38da4", 273131997,
					"data_sd.dcp", "e235c10ece56ac3056ebfa851726dca6", 97169915,
					"i18n_it_strings.dcp", "ba71ea60d10a440b6604add1452994f6", 127751), Common::IT_ITA, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_HD_FILES),

	// Shadows on the Vatican - Act II: Wrath (Legacy Version) (Steam, Jun 2018) (German)
	WME_WINENTRY_3D_FLAGS("sotv2", "Legacy Version/Steam",
		WME_ENTRY3s("data.dcp", "0410ed71d9d6f133c703009edab38da4", 273131997,
					"data_sd.dcp", "e235c10ece56ac3056ebfa851726dca6", 97169915,
					"i18n_de_strings.dcp", "999727c3c9bae93f06d19c71337b5d66", 60429), Common::DE_DEU, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_HD_FILES),

	// Shadows on the Vatican - Act II: Wrath (Legacy Version) (Steam, Jun 2018) (Spanish)
	WME_WINENTRY_3D_FLAGS("sotv2", "Legacy Version/Steam",
		WME_ENTRY3s("data.dcp", "0410ed71d9d6f133c703009edab38da4", 273131997,
					"data_sd.dcp", "e235c10ece56ac3056ebfa851726dca6", 97169915,
					"i18n_es_strings.dcp", "fe5b26d90019d9601de6b3fb13daee87", 54964), Common::ES_ESP, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_HD_FILES),

	// Shadows on the Vatican - Act II: Wrath (Legacy Version) (Steam, Jun 2018) (French)
	WME_WINENTRY_3D_FLAGS("sotv2", "Legacy Version/Steam",
		WME_ENTRY3s("data.dcp", "0410ed71d9d6f133c703009edab38da4", 273131997,
					"data_sd.dcp", "e235c10ece56ac3056ebfa851726dca6", 97169915,
					"i18n_fr_strings.dcp", "4f336e2ba1941c006dab3c9ec543db69", 59086), Common::FR_FRA, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_HD_FILES),

	// Shadows on the Vatican - Act II: Wrath (Legacy Version) (Steam, Jun 2018) (Russian)
	WME_WINENTRY_3D_FLAGS("sotv2", "Legacy Version/Steam",
		WME_ENTRY3s("data.dcp", "0410ed71d9d6f133c703009edab38da4", 273131997,
					"data_sd.dcp", "e235c10ece56ac3056ebfa851726dca6", 97169915,
					"i18n_ru_strings.dcp", "f7243c0c9b1a9393fdd97b0c2496ba05", 73757), Common::RU_RUS, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_HD_FILES),

	// Shadows on the Vatican - Act II: Wrath (Legacy Version) (Steam, Jun 2018) (Polish)
	WME_WINENTRY_3D_FLAGS("sotv2", "Legacy Version/Steam",
		WME_ENTRY3s("data.dcp", "0410ed71d9d6f133c703009edab38da4", 273131997,
					"data_sd.dcp", "e235c10ece56ac3056ebfa851726dca6", 97169915,
					"i18n_pl_strings.dcp", "67c194c45375d2e26f8bf5ae17800944", 119354), Common::PL_POL, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_HD_FILES),

	// Shadows on the Vatican - Act II: Wrath (Full HD Version) (Steam, Oct 26th 2015) (English)
	WME_WINENTRY_3D_FLAGS("sotv2", "Full HD Version/Steam",
		WME_ENTRY3s("data.dcp", "cfea0d6c7e4a96627d16887c3480266a", 273132663,
					"data_hd.dcp", "a6a3c9dd40902bf6177349f70cc5d215", 259399315,
					"i18n_en_strings.dcp", "33db4beabfe9813f16133c97198b7520", 114808), Common::EN_ANY, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_SD_FILES),

	// Shadows on the Vatican - Act II: Wrath (Full HD Version) (Steam, Oct 26th 2015) (Italian)
	WME_WINENTRY_3D_FLAGS("sotv2", "Full HD Version/Steam",
		WME_ENTRY3s("data.dcp", "cfea0d6c7e4a96627d16887c3480266a", 273132663,
					"data_hd.dcp", "a6a3c9dd40902bf6177349f70cc5d215", 259399315,
					"i18n_it_strings.dcp", "1fefff6f0fb87abe9acf88da9af1a8e7", 127306), Common::IT_ITA, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_SD_FILES),

	// Shadows on the Vatican - Act II: Wrath (Full HD Version) (Steam, Oct 26th 2015) (German)
	WME_WINENTRY_3D_FLAGS("sotv2", "Full HD Version/Steam",
		WME_ENTRY3s("data.dcp", "cfea0d6c7e4a96627d16887c3480266a", 273132663,
					"data_hd.dcp", "a6a3c9dd40902bf6177349f70cc5d215", 259399315,
					"i18n_de_strings.dcp", "30a2d7f796b3924af7e77e28f52a18b0", 60239), Common::DE_DEU, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_SD_FILES),

	// Shadows on the Vatican - Act II: Wrath (Full HD Version) (Steam, Oct 29th 2015) (German)
	WME_WINENTRY_3D_FLAGS("sotv2", "Full HD Version/Steam",
		WME_ENTRY3s("data.dcp", "cfea0d6c7e4a96627d16887c3480266a", 273132663,
					"data_hd.dcp", "a6a3c9dd40902bf6177349f70cc5d215", 259399315,
					"i18n_de_strings.dcp", "1159db7384da56aae6953d1b943e4c57", 60737), Common::DE_DEU, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_SD_FILES),

	// Shadows on the Vatican - Act II: Wrath (Full HD Version) (Steam, Oct 26th 2015) (French)
	WME_WINENTRY_3D_FLAGS("sotv2", "Full HD Version/Steam",
		WME_ENTRY3s("data.dcp", "cfea0d6c7e4a96627d16887c3480266a", 273132663,
					"data_hd.dcp", "a6a3c9dd40902bf6177349f70cc5d215", 259399315,
					"i18n_fr_strings.dcp", "0ce3927e47f9ed8ca6668d0728508abb", 59087), Common::FR_FRA, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_SD_FILES),

	// Shadows on the Vatican - Act II: Wrath (Full HD Version) (Steam, Oct 26th 2015) (Russian)
	WME_WINENTRY_3D_FLAGS("sotv2", "Full HD Version/Steam",
		WME_ENTRY3s("data.dcp", "cfea0d6c7e4a96627d16887c3480266a", 273132663,
					"data_hd.dcp", "a6a3c9dd40902bf6177349f70cc5d215", 259399315,
					"i18n_ru_strings.dcp", "20aebb86e857f213fd46d24fba3f6b9c", 73828), Common::RU_RUS, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_SD_FILES),

	// Shadows on the Vatican - Act II: Wrath (Full HD Version) (Steam, Oct 26th 2015) (Polish)
	WME_WINENTRY_3D_FLAGS("sotv2", "Full HD Version/Steam",
		WME_ENTRY3s("data.dcp", "cfea0d6c7e4a96627d16887c3480266a", 273132663,
					"data_hd.dcp", "a6a3c9dd40902bf6177349f70cc5d215", 259399315,
					"i18n_pl_strings.dcp", "cc5e50a22672c17211008b6f710e2009", 119066), Common::PL_POL, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_SD_FILES),
	...
	WME_WINENTRY_3D_FLAGS("sotv2", "Full HD Version/Steam",
		WME_ENTRY3s("data.dcp", "e499fac283cf68c6a85638415c4ec083", 273132663,
					...
					"i18n_en_strings.dcp", "fe5b2bb6dd91bbac101f61f388ae8e09", 114808), Common::EN_ANY, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_SD_FILES),

	// Shadows on the Vatican - Act II: Wrath (Full HD Version) (Steam, Oct 31th 2015) (Italian)
	WME_WINENTRY_3D_FLAGS("sotv2", "Full HD Version/Steam",
		WME_ENTRY3s("data.dcp", "e499fac283cf68c6a85638415c4ec083", 273132663,
					"data_hd.dcp", "13b45668b605dea1829ca5f276de1339", 259399315,
					"i18n_it_strings.dcp", "cf17089a0c047e7521c4da4a534b0c75", 127245), Common::IT_ITA, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_SD_FILES),

	// Shadows on the Vatican - Act II: Wrath (Full HD Version) (Steam, Oct 31th 2015) (German)
	WME_WINENTRY_3D_FLAGS("sotv2", "Full HD Version/Steam",
		WME_ENTRY3s("data.dcp", "e499fac283cf68c6a85638415c4ec083", 273132663,
					"data_hd.dcp", "13b45668b605dea1829ca5f276de1339", 259399315,
					"i18n_de_strings.dcp", "e0285a53d947e6e6925094604d011d3c", 60728), Common::DE_DEU, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_SD_FILES),

	// Shadows on the Vatican - Act II: Wrath (Full HD Version) (Steam, Oct 31th 2015) (French)
	WME_WINENTRY_3D_FLAGS("sotv2", "Full HD Version/Steam",
		WME_ENTRY3s("data.dcp", "e499fac283cf68c6a85638415c4ec083", 273132663,
					"data_hd.dcp", "13b45668b605dea1829ca5f276de1339", 259399315,
					"i18n_fr_strings.dcp", "9155180fb4b3a727a5ae58555e77fe0f", 59087), Common::FR_FRA, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_SD_FILES),

	// Shadows on the Vatican - Act II: Wrath (Full HD Version) (Steam, Oct 31th 2015) (Russian)
	WME_WINENTRY_3D_FLAGS("sotv2", "Full HD Version/Steam",
		WME_ENTRY3s("data.dcp", "e499fac283cf68c6a85638415c4ec083", 273132663,
					"data_hd.dcp", "13b45668b605dea1829ca5f276de1339", 259399315,
					"i18n_ru_strings.dcp", "decc382f1e1c382e43f7a65f76177cc6", 73757), Common::RU_RUS, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_SD_FILES),

	// Shadows on the Vatican - Act II: Wrath (Full HD Version) (Steam, Oct 31th 2015) (Polish)
	WME_WINENTRY_3D_FLAGS("sotv2", "Full HD Version/Steam",
		WME_ENTRY3s("data.dcp", "e499fac283cf68c6a85638415c4ec083", 273132663,
					"data_hd.dcp", "13b45668b605dea1829ca5f276de1339", 259399315,
					"i18n_pl_strings.dcp", "70e7aac260fc6e114b9a52a163276889", 119066), Common::PL_POL, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_SD_FILES),
	...
	WME_WINENTRY_3D_FLAGS("sotv2", "Full HD Version/Steam",
		WME_ENTRY3s("data.dcp", "8c9aa3c3d705f61c753e2f54f3104b8e", 273131920,
					...
					"i18n_en_strings.dcp", "b53006a80b7c7c6c40d69ee4ac6eab0e", 114808), Common::EN_ANY, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_SD_FILES),

	// Shadows on the Vatican - Act II: Wrath (Full HD Version) (Steam, Nov 2015) (Italian)
	WME_WINENTRY_3D_FLAGS("sotv2", "Full HD Version/Steam",
		WME_ENTRY3s("data.dcp", "8c9aa3c3d705f61c753e2f54f3104b8e", 273131920,
					"data_hd.dcp", "b4d2ce0a1f5e2e342af7cbf74630300f", 259399911,
					"i18n_it_strings.dcp", "4c84c9662e758c14a127130e20895f65", 127245), Common::IT_ITA, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_SD_FILES),

	// Shadows on the Vatican - Act II: Wrath (Full HD Version) (Steam, Nov 2015) (German)
	WME_WINENTRY_3D_FLAGS("sotv2", "Full HD Version/Steam",
		WME_ENTRY3s("data.dcp", "8c9aa3c3d705f61c753e2f54f3104b8e", 273131920,
					"data_hd.dcp", "b4d2ce0a1f5e2e342af7cbf74630300f", 259399911,
					"i18n_de_strings.dcp", "3a454226e403b32ac3b16a15711afe3f", 60728), Common::DE_DEU, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_SD_FILES),

	// Shadows on the Vatican - Act II: Wrath (Full HD Version) (Steam, Nov 2015) (French)
	WME_WINENTRY_3D_FLAGS("sotv2", "Full HD Version/Steam",
		WME_ENTRY3s("data.dcp", "8c9aa3c3d705f61c753e2f54f3104b8e", 273131920,
					"data_hd.dcp", "b4d2ce0a1f5e2e342af7cbf74630300f", 259399911,
					"i18n_fr_strings.dcp", "b2c65cef26a889663e7311a15796469b", 59087), Common::FR_FRA, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_SD_FILES),

	// Shadows on the Vatican - Act II: Wrath (Full HD Version) (Steam, Nov 2015) (Russian)
	WME_WINENTRY_3D_FLAGS("sotv2", "Full HD Version/Steam",
		WME_ENTRY3s("data.dcp", "8c9aa3c3d705f61c753e2f54f3104b8e", 273131920,
					"data_hd.dcp", "b4d2ce0a1f5e2e342af7cbf74630300f", 259399911,
					"i18n_ru_strings.dcp", "d9efa7d1d872f81d4d8602d5b4eb4f70", 73757), Common::RU_RUS, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_SD_FILES),

	// Shadows on the Vatican - Act II: Wrath (Full HD Version) (Steam, Nov 2015) (Polish)
	WME_WINENTRY_3D_FLAGS("sotv2", "Full HD Version/Steam",
		WME_ENTRY3s("data.dcp", "8c9aa3c3d705f61c753e2f54f3104b8e", 273131920,
					"data_hd.dcp", "b4d2ce0a1f5e2e342af7cbf74630300f", 259399911,
					"i18n_pl_strings.dcp", "31da3aa3c184282290f5e418e6412eb3", 119066), Common::PL_POL, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_SD_FILES),
	...
	WME_WINENTRY_3D_FLAGS("sotv2", "Full HD Version/Steam",
		WME_ENTRY3s("data.dcp", "988f6f424110bf0d88b9c8066809df84", 273131920,
					...
					"i18n_en_strings.dcp", "699872d03e5c379299d1cd75894c6ef5", 114808), Common::EN_ANY, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_SD_FILES),

	// Shadows on the Vatican - Act II: Wrath (Full HD Version) (Steam, Jan 2016) (Italian)
	WME_WINENTRY_3D_FLAGS("sotv2", "Full HD Version/Steam",
		WME_ENTRY3s("data.dcp", "988f6f424110bf0d88b9c8066809df84", 273131920,
					"data_hd.dcp", "a5670ea7c401ce187a54223bdc101408", 259399911,
					"i18n_it_strings.dcp", "fd8a38801ff03401447e9507965841b2", 127245), Common::IT_ITA, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_SD_FILES),

	// Shadows on the Vatican - Act II: Wrath (Full HD Version) (Steam, Jan 2016) (German)
	WME_WINENTRY_3D_FLAGS("sotv2", "Full HD Version/Steam",
		WME_ENTRY3s("data.dcp", "988f6f424110bf0d88b9c8066809df84", 273131920,
					"data_hd.dcp", "a5670ea7c401ce187a54223bdc101408", 259399911,
					"i18n_de_strings.dcp", "56057bb46e86965e2b5d5ca7823baad5", 60235), Common::DE_DEU, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_SD_FILES),

	// Shadows on the Vatican - Act II: Wrath (Full HD Version) (Steam, Jan 2016) (French)
	WME_WINENTRY_3D_FLAGS("sotv2", "Full HD Version/Steam",
		WME_ENTRY3s("data.dcp", "988f6f424110bf0d88b9c8066809df84", 273131920,
					"data_hd.dcp", "a5670ea7c401ce187a54223bdc101408", 259399911,
					"i18n_fr_strings.dcp", "29a3a13a8bf787c0811eba67f7c59b41", 59087), Common::FR_FRA, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_SD_FILES),

	// Shadows on the Vatican - Act II: Wrath (Full HD Version) (Steam, Jan 2016) (Russian)
	WME_WINENTRY_3D_FLAGS("sotv2", "Full HD Version/Steam",
		WME_ENTRY3s("data.dcp", "988f6f424110bf0d88b9c8066809df84", 273131920,
					"data_hd.dcp", "a5670ea7c401ce187a54223bdc101408", 259399911,
					"i18n_ru_strings.dcp", "92ddba944cc23ad12122bf571ac6b856", 73757), Common::RU_RUS, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_SD_FILES),

	// Shadows on the Vatican - Act II: Wrath (Full HD Version) (Steam, Jan 2016) (Polish)
	WME_WINENTRY_3D_FLAGS("sotv2", "Full HD Version/Steam",
		WME_ENTRY3s("data.dcp", "988f6f424110bf0d88b9c8066809df84", 273131920,
					"data_hd.dcp", "a5670ea7c401ce187a54223bdc101408", 259399911,
					"i18n_pl_strings.dcp", "a3729952b1e24d2d4367dd07a735235b", 119066), Common::PL_POL, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_SD_FILES),
	...
	WME_WINENTRY_3D_FLAGS("sotv2", "Full HD Version/Steam",
		WME_ENTRY3s("data.dcp", "208df61df9b95c9d9d0107877eb2f4d7", 273131926,
					...
					"i18n_en_strings.dcp", "6a389c7509da41c4e15b63a7c0530243", 114808), Common::EN_ANY, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_SD_FILES),

	// Shadows on the Vatican - Act II: Wrath (Full HD Version) (Steam, May 2016) (Italian)
	WME_WINENTRY_3D_FLAGS("sotv2", "Full HD Version/Steam",
		WME_ENTRY3s("data.dcp", "208df61df9b95c9d9d0107877eb2f4d7", 273131926,
					"data_hd.dcp", "79a959116026a085435d1cc95bfa9570", 265023033,
					"i18n_it_strings.dcp", "6222689f42ea2948e3d38e537710383f", 127239), Common::IT_ITA, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_SD_FILES),

	// Shadows on the Vatican - Act II: Wrath (Full HD Version) (Steam, May 2016) (German)
	WME_WINENTRY_3D_FLAGS("sotv2", "Full HD Version/Steam",
		WME_ENTRY3s("data.dcp", "208df61df9b95c9d9d0107877eb2f4d7", 273131926,
					"data_hd.dcp", "79a959116026a085435d1cc95bfa9570", 265023033,
					"i18n_de_strings.dcp", "975928849951229f497de36e1a707b61", 60230), Common::DE_DEU, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_SD_FILES),

	// Shadows on the Vatican - Act II: Wrath (Full HD Version) (Steam, May 2016) (Spanish)
	WME_WINENTRY_3D_FLAGS("sotv2", "Full HD Version/Steam",
		WME_ENTRY3s("data.dcp", "208df61df9b95c9d9d0107877eb2f4d7", 273131926,
					"data_hd.dcp", "79a959116026a085435d1cc95bfa9570", 265023033,
					"i18n_es_strings.dcp", "83d88a4b2e5da2a40ac981fcfa9a95bc", 55013), Common::ES_ESP, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_SD_FILES),

	// Shadows on the Vatican - Act II: Wrath (Full HD Version) (Steam, May 2016) (French)
	WME_WINENTRY_3D_FLAGS("sotv2", "Full HD Version/Steam",
		WME_ENTRY3s("data.dcp", "208df61df9b95c9d9d0107877eb2f4d7", 273131926,
					"data_hd.dcp", "79a959116026a085435d1cc95bfa9570", 265023033,
					"i18n_fr_strings.dcp", "6bfc2f1753141e28d22756d9768f4d44", 59086), Common::FR_FRA, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_SD_FILES),

	// Shadows on the Vatican - Act II: Wrath (Full HD Version) (Steam, May 2016) (Russian)
	WME_WINENTRY_3D_FLAGS("sotv2", "Full HD Version/Steam",
		WME_ENTRY3s("data.dcp", "208df61df9b95c9d9d0107877eb2f4d7", 273131926,
					"data_hd.dcp", "79a959116026a085435d1cc95bfa9570", 265023033,
					"i18n_ru_strings.dcp", "e85982376d9fb1c21e1acc8272b49412", 73757), Common::RU_RUS, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_SD_FILES),

	// Shadows on the Vatican - Act II: Wrath (Full HD Version) (Steam, May 2016) (Polish)
	WME_WINENTRY_3D_FLAGS("sotv2", "Full HD Version/Steam",
		WME_ENTRY3s("data.dcp", "208df61df9b95c9d9d0107877eb2f4d7", 273131926,
					"data_hd.dcp", "79a959116026a085435d1cc95bfa9570", 265023033,
					"i18n_pl_strings.dcp", "5ba1e92f1fc762ecec74104f4588ba04", 119066), Common::PL_POL, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_SD_FILES),
	...
	WME_WINENTRY_3D_FLAGS("sotv2", "Full HD Version/Steam",
		WME_ENTRY3s("data.dcp", "73b14ef68eecd41afbe39c2c4f671986", 273131946,
					...
					"i18n_en_strings.dcp", "250626c49627e5f3f18883d6eb71e869", 114808), Common::EN_ANY, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_SD_FILES),

	// Shadows on the Vatican - Act II: Wrath (Full HD Version) (Steam, Sep 2016) (Italian)
	WME_WINENTRY_3D_FLAGS("sotv2", "Full HD Version/Steam",
		WME_ENTRY3s("data.dcp", "73b14ef68eecd41afbe39c2c4f671986", 273131946,
					"data_hd.dcp", "d7d7fbdbf0ec41eddf92078d38be8de5", 271652871,
					"i18n_it_strings.dcp", "338be9aa9c611e349ab7c0a4065a6c78", 127241), Common::IT_ITA, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_SD_FILES),

	// Shadows on the Vatican - Act II: Wrath (Full HD Version) (Steam, Sep 2016) (German)
	WME_WINENTRY_3D_FLAGS("sotv2", "Full HD Version/Steam",
		WME_ENTRY3s("data.dcp", "73b14ef68eecd41afbe39c2c4f671986", 273131946,
					"data_hd.dcp", "d7d7fbdbf0ec41eddf92078d38be8de5", 271652871,
					"i18n_de_strings.dcp", "46811e68b29fd07e115343e17c53f676", 60429), Common::DE_DEU, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_SD_FILES),

	// Shadows on the Vatican - Act II: Wrath (Full HD Version) (Steam, Sep 2016) (Spanish)
	WME_WINENTRY_3D_FLAGS("sotv2", "Full HD Version/Steam",
		WME_ENTRY3s("data.dcp", "73b14ef68eecd41afbe39c2c4f671986", 273131946,
					"data_hd.dcp", "d7d7fbdbf0ec41eddf92078d38be8de5", 271652871,
					"i18n_es_strings.dcp", "61e518d05b62a48827ce6fa0a95e8021", 54964), Common::ES_ESP, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_SD_FILES),

	// Shadows on the Vatican - Act II: Wrath (Full HD Version) (Steam, Sep 2016) (French)
	WME_WINENTRY_3D_FLAGS("sotv2", "Full HD Version/Steam",
		WME_ENTRY3s("data.dcp", "73b14ef68eecd41afbe39c2c4f671986", 273131946,
					"data_hd.dcp", "d7d7fbdbf0ec41eddf92078d38be8de5", 271652871,
					"i18n_fr_strings.dcp", "4605094d334272dd2bc3ba3203b36c48", 59086), Common::FR_FRA, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_SD_FILES),

	// Shadows on the Vatican - Act II: Wrath (Full HD Version) (Steam, Sep 2016) (Russian)
	WME_WINENTRY_3D_FLAGS("sotv2", "Full HD Version/Steam",
		WME_ENTRY3s("data.dcp", "73b14ef68eecd41afbe39c2c4f671986", 273131946,
					"data_hd.dcp", "d7d7fbdbf0ec41eddf92078d38be8de5", 271652871,
					"i18n_ru_strings.dcp", "8a948c77f185feac630600e3d8f55195", 73757), Common::RU_RUS, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_SD_FILES),

	// Shadows on the Vatican - Act II: Wrath (Full HD Version) (Steam, Sep 2016) (Polish)
	WME_WINENTRY_3D_FLAGS("sotv2", "Full HD Version/Steam",
		WME_ENTRY3s("data.dcp", "73b14ef68eecd41afbe39c2c4f671986", 273131946,
					"data_hd.dcp", "d7d7fbdbf0ec41eddf92078d38be8de5", 271652871,
					"i18n_pl_strings.dcp", "4a07c25e2d082320880536cc2a835868", 119077), Common::PL_POL, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_SD_FILES),
	...
	WME_WINENTRY_3D_FLAGS("sotv2", "Full HD Version/Steam",
		WME_ENTRY3s("data.dcp", "f04bc0d4fb2034adea3e7f9652b617ec", 273131946,
					...
					"i18n_en_strings.dcp", "db0db417d6dc8c70de625ee7520d5e40", 114808), Common::EN_ANY, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_SD_FILES),

	// Shadows on the Vatican - Act II: Wrath (Full HD Version) (Steam, Oct 2016) (Italian)
	WME_WINENTRY_3D_FLAGS("sotv2", "Full HD Version/Steam",
		WME_ENTRY3s("data.dcp", "f04bc0d4fb2034adea3e7f9652b617ec", 273131946,
					"data_hd.dcp", "5e4f57e77da13286bfa22ab157fcf147", 271652871,
					"i18n_it_strings.dcp", "809c993d42983fe8664a628804cba98e", 127241), Common::IT_ITA, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_SD_FILES),

	// Shadows on the Vatican - Act II: Wrath (Full HD Version) (Steam, Oct 2016) (German)
	WME_WINENTRY_3D_FLAGS("sotv2", "Full HD Version/Steam",
		WME_ENTRY3s("data.dcp", "f04bc0d4fb2034adea3e7f9652b617ec", 273131946,
					"data_hd.dcp", "5e4f57e77da13286bfa22ab157fcf147", 271652871,
					"i18n_de_strings.dcp", "e6570cb5365d6122e0ac549f83945a9f", 60429), Common::DE_DEU, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_SD_FILES),

	// Shadows on the Vatican - Act II: Wrath (Full HD Version) (Steam, Oct 2016) (Spanish)
	WME_WINENTRY_3D_FLAGS("sotv2", "Full HD Version/Steam",
		WME_ENTRY3s("data.dcp", "f04bc0d4fb2034adea3e7f9652b617ec", 273131946,
					"data_hd.dcp", "5e4f57e77da13286bfa22ab157fcf147", 271652871,
					"i18n_es_strings.dcp", "c06845d464212b022c7eee21cc6502d1", 54964), Common::ES_ESP, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_SD_FILES),

	// Shadows on the Vatican - Act II: Wrath (Full HD Version) (Steam, Oct 2016) (French)
	WME_WINENTRY_3D_FLAGS("sotv2", "Full HD Version/Steam",
		WME_ENTRY3s("data.dcp", "f04bc0d4fb2034adea3e7f9652b617ec", 273131946,
					"data_hd.dcp", "5e4f57e77da13286bfa22ab157fcf147", 271652871,
					"i18n_fr_strings.dcp", "47ff2736401cde872ef454f41a5216ec", 59086), Common::FR_FRA, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_SD_FILES),

	// Shadows on the Vatican - Act II: Wrath (Full HD Version) (Steam, Oct 2016) (Russian)
	WME_WINENTRY_3D_FLAGS("sotv2", "Full HD Version/Steam",
		WME_ENTRY3s("data.dcp", "f04bc0d4fb2034adea3e7f9652b617ec", 273131946,
					"data_hd.dcp", "5e4f57e77da13286bfa22ab157fcf147", 271652871,
					"i18n_ru_strings.dcp", "5ffe06a72c914d287878f2f018109f04", 73757), Common::RU_RUS, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_SD_FILES),

	// Shadows on the Vatican - Act II: Wrath (Full HD Version) (Steam, Oct 2016) (Polish)
	WME_WINENTRY_3D_FLAGS("sotv2", "Full HD Version/Steam",
		WME_ENTRY3s("data.dcp", "f04bc0d4fb2034adea3e7f9652b617ec", 273131946,
					"data_hd.dcp", "5e4f57e77da13286bfa22ab157fcf147", 271652871,
					"i18n_pl_strings.dcp", "43df37eaa12d9a60561297a199ba0e70", 119077), Common::PL_POL, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_SD_FILES),
	...
	WME_WINENTRY_3D_FLAGS("sotv2", "Full HD Version/Steam",
		WME_ENTRY3s("data.dcp", "0410ed71d9d6f133c703009edab38da4", 273131997,
					...
					"i18n_en_strings.dcp", "4b6a631516bd9bd1aa20028b0c7266bd", 114808), Common::EN_ANY, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_SD_FILES),

	// Shadows on the Vatican - Act II: Wrath (Full HD Version) (Steam, Jun 2018) (Italian)
	WME_WINENTRY_3D_FLAGS("sotv2", "Full HD Version/Steam",
		WME_ENTRY3s("data.dcp", "0410ed71d9d6f133c703009edab38da4", 273131997,
					"data_hd.dcp", "61b79bd9f732e48bb097227ee615463b", 272405838,
					"i18n_it_strings.dcp", "ba71ea60d10a440b6604add1452994f6", 127751), Common::IT_ITA, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_SD_FILES),

	// Shadows on the Vatican - Act II: Wrath (Full HD Version) (Steam, Jun 2018) (German)
	WME_WINENTRY_3D_FLAGS("sotv2", "Full HD Version/Steam",
		WME_ENTRY3s("data.dcp", "0410ed71d9d6f133c703009edab38da4", 273131997,
					"data_hd.dcp", "61b79bd9f732e48bb097227ee615463b", 272405838,
					"i18n_de_strings.dcp", "999727c3c9bae93f06d19c71337b5d66", 60429), Common::DE_DEU, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_SD_FILES),

	// Shadows on the Vatican - Act II: Wrath (Full HD Version) (Steam, Jun 2018) (Spanish)
	WME_WINENTRY_3D_FLAGS("sotv2", "Full HD Version/Steam",
		WME_ENTRY3s("data.dcp", "0410ed71d9d6f133c703009edab38da4", 273131997,
					"data_hd.dcp", "61b79bd9f732e48bb097227ee615463b", 272405838,
					"i18n_es_strings.dcp", "fe5b26d90019d9601de6b3fb13daee87", 54964), Common::ES_ESP, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_SD_FILES),

	// Shadows on the Vatican - Act II: Wrath (Full HD Version) (Steam, Jun 2018) (French)
	WME_WINENTRY_3D_FLAGS("sotv2", "Full HD Version/Steam",
		WME_ENTRY3s("data.dcp", "0410ed71d9d6f133c703009edab38da4", 273131997,
					"data_hd.dcp", "61b79bd9f732e48bb097227ee615463b", 272405838,
					"i18n_fr_strings.dcp", "4f336e2ba1941c006dab3c9ec543db69", 59086), Common::FR_FRA, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_SD_FILES),

	// Shadows on the Vatican - Act II: Wrath (Full HD Version) (Steam, Jun 2018) (Russian)
	WME_WINENTRY_3D_FLAGS("sotv2", "Full HD Version/Steam",
		WME_ENTRY3s("data.dcp", "0410ed71d9d6f133c703009edab38da4", 273131997,
					"data_hd.dcp", "61b79bd9f732e48bb097227ee615463b", 272405838,
					"i18n_ru_strings.dcp", "f7243c0c9b1a9393fdd97b0c2496ba05", 73757), Common::RU_RUS, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_SD_FILES),

	// Shadows on the Vatican - Act II: Wrath (Full HD Version) (Steam, Jun 2018) (Polish)
	WME_WINENTRY_3D_FLAGS("sotv2", "Full HD Version/Steam",
		WME_ENTRY3s("data.dcp", "0410ed71d9d6f133c703009edab38da4", 273131997,
					"data_hd.dcp", "61b79bd9f732e48bb097227ee615463b", 272405838,
					"i18n_pl_strings.dcp", "67c194c45375d2e26f8bf5ae17800944", 119354), Common::PL_POL, ADGF_UNSTABLE, WME_1_9_3, GF_IGNORE_SD_FILES),
	...
	// Strange Change
	WME_WINENTRY_3D("strangechange", "",
		WME_ENTRY1s("data.dcp", "818e53c1584dac28f336195d7dcfb97d", 3762512), Common::EN_ANY, ADGF_UNSTABLE, WME_1_8_6),
	...
	WME_WINENTRY_3D("sunrise", "",
		WME_ENTRY1s("data.dcp", "d06744fc60982a30e82d96075698c8bc", 134409552), Common::DE_DEU, ADGF_UNSTABLE, WME_1_7_93),

	// Sunrise: The game (Demo) (German)
	WME_WINENTRY_3D("sunrise", "Demo",
		WME_ENTRY1s("data.dcp", "3bac4da87472d2e7676e9548970d521a", 52095549), Common::DE_DEU, ADGF_UNSTABLE | ADGF_DEMO, WME_1_7_93),

	// Susan Rose: Mysterious Child
	WME_WINENTRY_3D("susanrose1", "",
		WME_ENTRY1s("data.dcp", "bc607fe93d6751de2d0d0b7f4b2c90f8", 798965082), Common::RU_RUS, ADGF_UNSTABLE, WME_1_8_9),

	// Susan Rose: Delicate Murder
	WME_WINENTRY_3D("susanrose2", "",
		WME_ENTRY1s("data.dcp", "789660631a79ed76d95446d1f1e6e694", 922032035), Common::RU_RUS, ADGF_UNSTABLE, WME_1_8_11),
	...
	WME_WINENTRY_3D("tehran1933", "",
		WME_ENTRY1s("data.dcp", "0ab314e014b5e9d45411fee436d98dfd", 1921736252), Common::FA_IRN, ADGF_UNSTABLE, WME_1_9_1),

	// Murder In Tehran's Alleys 1933 (Hayoola) (Persian)
	WME_WINENTRY_3D("tehran1933", "",
		WME_ENTRY1s("data.dcp", "acc00770c734c8c5bb25141f6d3bd82d", 872649217), Common::FA_IRN, ADGF_UNSTABLE, WME_1_9_1),
	...
	WME_WINENTRY_3D("tehran2016", "",
		WME_ENTRY1s("data.dcp", "24c54a6f4dc9ff0498972ae4572df2ee", 1156014223), Common::FA_IRN, ADGF_UNSTABLE, WME_1_9_1),
	...
	WME_WINENTRY_3D("thelastcrownmh", "",
	...
	WME_WINENTRY_3D("thelostcrowngha", "",
	...
	WME_WINENTRY_3D("thelostcrowngha", "Steam",
	...
	WME_WINENTRY_3D("wayoflove", "",
		WME_ENTRY2s("data.dcp", "e86fcca7d5044998945a6e1e7a874430", 1650426981,
					"language.dcp", "91b100d10719bcfc355739a41f4eca4b", 662313), Common::FA_IRN, ADGF_UNSTABLE, WME_1_9_3),

	// The Way Of Love: Sub Zero (English)
	WME_WINENTRY_3D("wayoflove", "",
		WME_ENTRY2s("data.dcp", "201d74cce6b89ce6d5b61a24b5e88809", 1224687223,
					"language.dcp", "97ae6c028be982ca419416fab77efc76", 663912), Common::EN_ANY, ADGF_UNSTABLE, WME_1_9_3),
	...
	WME_WINENTRY_3D("wmedemo3d", "Demo",

...
static const FreescapeGameDescription gameDescriptions[] = {
...
class FreescapeMetaEngineDetection : public AdvancedMetaEngineDetection<Freescape::FreescapeGameDescription> {
public:

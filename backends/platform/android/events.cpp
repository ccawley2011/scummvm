...
//				}
	...
	case JE_GAMEPAD:
		...
		switch (arg2) {
		case AKEYCODE_BUTTON_A:      e.joystick.button = Common::JOYSTICK_BUTTON_A;                break;
		case AKEYCODE_BUTTON_B:      e.joystick.button = Common::JOYSTICK_BUTTON_B;                break;
		case AKEYCODE_BUTTON_C:      e.joystick.button = Common::JOYSTICK_BUTTON_C;                break;
		case AKEYCODE_BUTTON_X:      e.joystick.button = Common::JOYSTICK_BUTTON_X;                break;
		case AKEYCODE_BUTTON_Y:      e.joystick.button = Common::JOYSTICK_BUTTON_Y;                break;
		case AKEYCODE_BUTTON_Z:      e.joystick.button = Common::JOYSTICK_BUTTON_Z;                break;
		case AKEYCODE_BUTTON_L1:     e.joystick.button = Common::JOYSTICK_BUTTON_LEFT_SHOULDER;    break;
		case AKEYCODE_BUTTON_R1:     e.joystick.button = Common::JOYSTICK_BUTTON_RIGHT_SHOULDER;   break;
		case AKEYCODE_BUTTON_L2:     e.joystick.button = Common::JOYSTICK_BUTTON_LEFT_SHOULDER_2;  break;
		case AKEYCODE_BUTTON_R2:     e.joystick.button = Common::JOYSTICK_BUTTON_RIGHT_SHOULDER_2; break;
		case AKEYCODE_BUTTON_THUMBL: e.joystick.button = Common::JOYSTICK_BUTTON_LEFT_STICK;       break;
		case AKEYCODE_BUTTON_THUMBR: e.joystick.button = Common::JOYSTICK_BUTTON_RIGHT_STICK;      break;
		case AKEYCODE_BUTTON_START:  e.joystick.button = Common::JOYSTICK_BUTTON_START;            break;
		case AKEYCODE_BUTTON_SELECT: e.joystick.button = Common::JOYSTICK_BUTTON_BACK;             break;
		case AKEYCODE_BUTTON_MODE:   e.joystick.button = Common::JOYSTICK_BUTTON_GUIDE;            break;
		case AKEYCODE_BUTTON_1:      e.joystick.button = Common::JOYSTICK_BUTTON_A;                break;
		case AKEYCODE_BUTTON_2:      e.joystick.button = Common::JOYSTICK_BUTTON_B;                break;
		case AKEYCODE_BUTTON_3:      e.joystick.button = Common::JOYSTICK_BUTTON_X;                break;
		case AKEYCODE_BUTTON_4:      e.joystick.button = Common::JOYSTICK_BUTTON_Y;                break;
		default:
